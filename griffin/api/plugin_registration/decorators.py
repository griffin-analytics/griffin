...
"""
Griffin API plugin registration decorators.
"""
...
def on_plugin_available(func: Callable = None,
    ...
    """
    Method decorator used to handle plugin availability on Griffin.
...
def on_plugin_teardown(func: Callable = None,
                       plugin: Optional[str] = None):
    """
    Method decorator used to handle plugin teardown on Griffin.
