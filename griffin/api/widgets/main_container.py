...
GriffinPluginV2 plugins must provide a CONTAINER_CLASS attribute that is a
...
class PluginMainContainer(QWidget, GriffinWidgetMixin):
    """
    Griffin plugin main container class.
    ...
    Notes
    -----
    All Griffin non dockable plugins can define a plugin container that must
    subclass this.
    """
