...
GriffinDockablePlugin plugins must provide a WIDGET_CLASS attribute that is a
...
from griffin.api.widgets import PluginMainWidgetActions, PluginMainWidgetWidgets
from griffin.api.widgets.auxiliary_widgets import (MainCornerWidget,
                                                  GriffinWindowWidget)
from griffin.api.widgets.menus import (
    PluginMainWidgetOptionsMenu,
    OptionsMenuSections,
    PluginMainWidgetMenus
)
from griffin.api.widgets.mixins import GriffinWidgetMixin
from griffin.api.widgets.toolbars import MainWidgetToolbar
from griffin.py3compat import qbytearray_to_str
from griffin.utils.qthelpers import create_waitspinner
from griffin.utils.registries import ACTION_REGISTRY, TOOLBAR_REGISTRY
from griffin.utils.stylesheet import (
    AppStyle, APP_STYLESHEET, PANES_TABBAR_STYLESHEET,
    PANES_TOOLBAR_STYLESHEET)
from griffin.widgets.dock import DockTitleBar, GriffinDockWidget
...
class PluginMainWidget(QWidget, GriffinWidgetMixin):
    """
    Griffin plugin main widget class.
    ...
    Notes
    -----
    All Griffin dockable plugins define a main widget that must subclass this.
    ...
    def __init__(self, name, plugin, parent=None):
        if PYQT5 or PYQT6:
            ...
            GriffinWidgetMixin.__init__(self, class_parent=plugin)
    ...
    def show_status_message(self, message, timeout):
        """
        Show a status message in the Griffin widget.
        """
    ...
    def create_window(self):
        ...
        # Widgets
        self.windowwidget = window = GriffinWindowWidget(self)
    ...
    def _close_window(self, save_undocked=False, switch_to_plugin=True):
        ...
        if self.windowwidget is not None:
            ...
            # Fixes griffin-ide/griffin#10704
    ...
    def create_dockwidget(self, mainwindow):
        ...
        self.dockwidget = dock = GriffinDockWidget(title, mainwindow)
