...
from griffin.api.widgets import PluginMainWidgetWidgets
from griffin.api.widgets.mixins import GriffinMainWindowMixin
from griffin.utils.stylesheet import APP_STYLESHEET


class GriffinWindowWidget(QMainWindow, GriffinMainWindowMixin):
    """MainWindow subclass that contains a GriffinDockablePlugin."""
    ...
    def __init__(self, widget):
        ...
        # To distinguish these windows from the main Griffin one
