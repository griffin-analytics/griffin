...
from griffin.utils.misc import regexp_error_msg
from griffin.plugins.editor.utils.editor import TextHelper
from griffin.utils.qthelpers import create_toolbutton
from griffin.utils.sourcecode import get_eol_chars
from griffin.utils.stylesheet import AppStyle
from griffin.widgets.comboboxes import PatternComboBox
...
class FindReplace(QWidget, GriffinShortcutsMixin):
    """Find widget"""
    ...
    def replace_find(self, focus_replace_text=False):
        ...
        if self.re_button.isChecked():
            try:
                ...
                # Fixes griffin-ide/griffin#7177.
