...
These classes were created to be able to provide Griffin's regular text and
...
from griffin_kernels.utils.dochelpers import (getargspecfromtext, getobj,
...
from griffin.utils.misc import get_error_match
from griffin.utils.palette import GriffinPalette
from griffin.widgets.arraybuilder import ArrayBuilderDialog
...
# Tips style
TIP_TEXT_COLOR = GriffinPalette.COLOR_TEXT_2
TIP_PARAMETER_HIGHLIGHT_COLOR = GriffinPalette.COLOR_TEXT_1
...
class BaseEditMixin(object):
    ...
    def _format_text(self, title=None, signature=None, text=None,
        ...
        if title:
            template += BASE_TEMPLATE.format(
                ...
                size=text_size,
                color=GriffinPalette.TIP_TITLE_COLOR,
                main_text=title,
            )
        ...
        if help_text and inspect_word:
            if display_link:
                template += (
                    f'<hr>'
                    f'<div align="left">'
                    f'<span style="color: {GriffinPalette.TIP_TITLE_COLOR};'
    ...
    def _format_signature(self, signatures, parameter=None,
        ...
        chars_template = (
            '<span style="color:{0};'.format(
                GriffinPalette.TIP_CHAR_HIGHLIGHT_COLOR
            ) +
    ...
    def _check_signature_and_format(self, signature_or_text, parameter=None,
        ...
        # Remove 'ufunc' signature if needed. See griffin-ide/griffin#11821
    ...
    def get_text(self, position_from, position_to, remove_newlines=True):
        ...
        griffin-ide/griffin#1546 and later caused griffin-ide/griffin#14374.
    ...
    def inputMethodQuery(self, query):
        ...
        Notes
        -----
        This was suggested by a user in griffin-ide/griffin#23313. So, it's not
        tested by us.
        """
