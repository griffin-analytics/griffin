...
# Local imports
from griffin.api.widgets.comboboxes import GriffinComboBox, GriffinFontComboBox
...
from griffin.widgets.colors import ColorLayout
from griffin.widgets.helperwidgets import TipWidget, ValidationLineEdit
from griffin.widgets.comboboxes import FileComboBox
from griffin.widgets.sidebardialog import SidebarPage
...
class ConfigAccessMixin:
    """Mixin to access config options in GriffinConfigPages."""
    CONF_SECTION = None
...
class GriffinConfigPage(SidebarPage, ConfigAccessMixin):
    """
    ...
    def create_combobox(self, text, choices, option, default=NoDefault,
        ...
        if section is not None and section != self.CONF_SECTION:
            self.cross_section_options[option] = section
        label = QLabel(text)
        combobox = GriffinComboBox(items_elide_mode=items_elide_mode)
