...
# Local imports
from griffin import (__project_url__, __trouble_url__, dependencies,
                    get_versions_text)
...
from griffin.plugins.console.widgets.console import ConsoleBaseWidget
from griffin.utils.conda import find_conda
from griffin.utils.icon_manager import ima
from griffin.utils.programs import run_program
from griffin.utils.qthelpers import restore_keyevent
from griffin.widgets.github.backend import GithubBackend
from griffin.widgets.mixins import BaseEditMixin, TracebackLinksMixin
...
class DescriptionWidget(SimpleCodeEditor, GriffinFontsMixin):
    ...
    def __init__(self, parent=None):
        ...
        self.setup_editor(
            language='md',
            font=self.get_font(
                GriffinFontType.MonospaceInterface, font_size_delta=1
            ),
            wrap=True,
            linenumbers=False,
...
class ShowErrorWidget(TracebackLinksMixin, ConsoleBaseWidget, BaseEditMixin,
    ...
    def __init__(self, parent=None):
        ...
        self.set_pythonshell_font(
            self.get_font(GriffinFontType.MonospaceInterface, font_size_delta=1)
        )


class GriffinErrorDialog(QDialog, GriffinConfigurationAccessor):
    ...
    def __init__(self, parent=None, is_report=False):
        ...
        self._github_org = 'griffin-ide'
        self._github_repo = 'griffin'
        ...
        if self.is_report:
            ...
            title = _("Griffin has encountered an internal problem!")
