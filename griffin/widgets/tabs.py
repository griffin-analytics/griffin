...
from griffin.utils.qthelpers import (add_actions, create_action,
                                    create_toolbutton)
from griffin.utils.stylesheet import MAC, PANES_TABBAR_STYLESHEET, WIN
...
class CloseTabButton(QToolButton):
    ...
    def __init__(self, parent, index):
        ...
        self._selected_tab_color = GriffinPalette.COLOR_BACKGROUND_5
        self._not_selected_tab_color = GriffinPalette.COLOR_BACKGROUND_4

        self._hover_selected_tab_color = GriffinPalette.COLOR_BACKGROUND_6
        self._hover_not_selected_tab_color = GriffinPalette.COLOR_BACKGROUND_5

        self._clicked_selected_tab_color = (
            Gray.B70 if is_dark_interface() else Gray.B80
        )
        self._clicked_not_selected_tab_color = GriffinPalette.COLOR_BACKGROUND_6
...
class BaseTabs(QTabWidget):
    ...
    def __init__(self, parent, actions=None, menu=None,
        ...
        self.browse_tabs_menu = GriffinMenu(self)
    ...
    def get_offset_pos(self, event):
        ...
        # widget, not in the tabBar. see griffin-ide/griffin#12617
        tb = self.tabBar()
...
class Tabs(BaseTabs, GriffinShortcutsMixin):
    ...
    def __init__(self, parent, actions=None, menu=None,
        ...
        GriffinShortcutsMixin.__init__(self)
