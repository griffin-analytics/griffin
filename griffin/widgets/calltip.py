...
# Copyright (c) 2013- Griffin Project Contributors
#
...
BACKGROUND_COLOR = (
    GriffinPalette.COLOR_BACKGROUND_4 if is_dark_interface() else
    GriffinPalette.COLOR_BACKGROUND_2
)
...
class ToolTipWidget(QLabel):
    ...
    def _stylesheet(self):
        ...
        css["ToolTipWidget"].setValues(
            ...
            border=f"1px solid {GriffinPalette.COLOR_TEXT_4}"
        )
...
class CallTipWidget(QLabel):
    ...
    def hideEvent(self, event):
        ...
        # This is needed for issue griffin-ide/griffin#9221,
        try:
