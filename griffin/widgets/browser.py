...
from griffin.utils.qthelpers import (action2button, create_plugin_layout,
                                    create_toolbutton)
from griffin.widgets.comboboxes import UrlComboBox
...
class WebView(QWebEngineView, GriffinWidgetMixin):
    """
    Web view.
    """
    ...
    def setHtml(self, html, baseUrl=QUrl()):
        ...
        # Fixes griffin-ide/griffin#16703
        try:
    ...
    def load(self, url):
        ...
        # Fixes griffin-ide/griffin#19818
        try:
            self.focusProxy().installEventFilter(self)
        except AttributeError:
            pass
...
class FrameWebView(QFrame):
    """
    Framed WebView for UI consistency in Griffin.
    """
    linkClicked = Signal(QUrl)
