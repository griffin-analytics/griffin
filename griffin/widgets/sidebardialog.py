...
class SidebarPage(QWidget):
    ...
    def create_icon(name):
        """Create an icon by name using Griffin's icon manager."""
...
class SidebarDialog(QDialog, GriffinFontsMixin):
    """Sidebar dialog."""
    ...
    def __init__(self, parent=None):
        ...
        self.items_font = self.get_font(
            GriffinFontType.Interface, font_size_delta=1
        )
    ...
    def _generate_contents_stylesheet(self):
        ...
        css.QListView.setValues(
            ...
            border=f'1px solid {GriffinPalette.COLOR_BACKGROUND_2}',
        )
    ...
    def _contents_scrollbar_stylesheet(self):
        ...
        css.setValues(
            border=f"1px solid {GriffinPalette.COLOR_BACKGROUND_5}"
        )
