...
# Local imports
from griffin.widgets import mixins
...
def test_get_number_with_words(mixinsbot):
    ...
    Dedicated test for griffin-ide/griffin#7960.
    """
    qtbot, widget = mixinsbot
