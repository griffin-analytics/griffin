...
"""
Griffin appearance configuration
"""
...
APPEARANCE = {
    'css_path': CSS_PATH,
    'icon_theme': 'griffin 3',
    # This is our monospace font
    'font/family': MONOSPACE,
    'font/size': MEDIUM,
    'font/italic': False,
    'font/bold': False,
    # We set the app font used in the system when Griffin starts, so we don't
    # need to do it here.
    ...
    'names': ['emacs', 'idle', 'monokai', 'pydev', 'scintilla',
              'griffin', 'griffin/dark', 'zenburn', 'solarized/light',
    ...
    #       Name            Color     Bold  Italic
    'griffin/background':  LightPalette.COLOR_BACKGROUND_1,
    'griffin/currentline': "#f7ecf8",
    'griffin/currentcell': "#fdfdde",
    'griffin/occurrence':  "#C2E3FA",
    'griffin/ctrlclick':   "#0000ff",
    'griffin/sideareas':   "#efefef",
    'griffin/matched_p':   "#99ff99",
    'griffin/unmatched_p': "#ff9999",
    'griffin/normal':     (LightPalette.COLOR_TEXT_1, False, False),
    'griffin/keyword':    ('#0000ff', False, False),
    'griffin/magic':      ('#0000ff', False, False),
    'griffin/builtin':    ('#900090', False, False),
    'griffin/definition': ('#000000', True, False),
    'griffin/comment':    ('#adadad', False, True),
    'griffin/string':     ('#00aa00', False, False),
    'griffin/number':     ('#800000', False, False),
    'griffin/instance':   ('#924900', False, True),
    # ---- Griffin/Dark ----
    'griffin/dark/name':        "Griffin Dark",
    #           Name             Color     Bold  Italic
    #'griffin/dark/background':  "#19232D",
    'griffin/dark/background':  "#111927",
    'griffin/dark/currentline': "#3a424a",
    'griffin/dark/currentcell': "#292d3e",
    'griffin/dark/occurrence':  "#1A72BB",
    'griffin/dark/ctrlclick':   "#179ae0",
    'griffin/dark/sideareas':   "#222b35",
    'griffin/dark/matched_p':   "#0bbe0b",
    'griffin/dark/unmatched_p': "#ff4340",
    'griffin/dark/normal':     (DarkPalette.COLOR_TEXT_1, False, False),
    'griffin/dark/keyword':    ('#c670e0', False, False),
    'griffin/dark/magic':      ('#c670e0', False, False),
    'griffin/dark/builtin':    ('#fab16c', False, False),
    'griffin/dark/definition': ('#57d6e4', True, False),
    'griffin/dark/comment':    ('#999999', False, False),
    'griffin/dark/string':     ('#b0e686', False, True),
    'griffin/dark/number':     ('#faed5c', False, False),
    'griffin/dark/instance':   ('#ee6772', False, True),
    # ---- Zenburn ----
