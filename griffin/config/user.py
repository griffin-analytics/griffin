...
"""
This module provides user configuration file management features for Griffin.
...
# Local imports
from griffin.config.base import get_conf_path, get_module_source_path
...
class DefaultsConfig(cp.ConfigParser, object):
    ...
    def _save(self):
        ...
        # See griffin-ide/griffin#1086 and griffin-ide/griffin#1242 for background
        ...
        try:
            ...
            try:
                ...
                print('Failed to write user configuration file to disk, with '
                      'the exception shown below')  # griffin: test-skip
                print(e)  # griffin: test-skip
...
class UserConfig(DefaultsConfig):
    ...
    def __init__(self, name, path, defaults=None, load=True, version=None,
        ...
        self._module_source_path = get_module_source_path('griffin')
    ...
    def _load_from_ini(self, fpath):
        ...
        try:
            ...
            print(error_text)  # griffin: test-skip
...
class GriffinUserConfig(UserConfig):
    ...
    def get_previous_config_fpath(self):
        ...
        if self._external_plugin:
            ...
            previous_paths = [
                ...
                fpath,
                # < 51.0.0
                os.path.join(get_conf_path(), 'griffin.ini'),
            ]
    ...
    def get_config_fpath_from_version(self, version=None):
        ...
        if version is None or self._external_plugin:
            ...
            fpath = osp.join(get_conf_path(), 'griffin.ini')
        else:
            fpath = self.get_config_fpath()
    ...
    def get_backup_fpath_from_version(self, version=None, old_version=None):
        ...
        if old_version and check_version(old_version, '51.0.0', '<'):
            ...
            super_class = super(GriffinUserConfig, self)
