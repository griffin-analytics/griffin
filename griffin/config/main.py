...
from griffin.config.base import CHECK_ALL, EXCLUDED_NAMES
from griffin.config.utils import IMPORT_EXT
from griffin.config.appearance import APPEARANCE
from griffin.plugins.editor.utils.findtasks import TASKS_PATTERN
...
# Extensions that should be visible in Griffin's file/project explorers
SHOW_EXT = ['.py', '.ipynb', '.dat', '.pdf', '.png', '.svg', '.md', '.yml',
            '.yaml']

# Extensions supported by Griffin (Editor or Variable explorer)
...
NAME_MAP = {
    ...
    # These options change on griffin startup or are tied to a specific OS,
    ...
    'transient': [
        ...
        ('run', [
            ...
            'parameters',
            'last_used_parameters', # Needed for Griffin 6.0.0 to 6.0.3
