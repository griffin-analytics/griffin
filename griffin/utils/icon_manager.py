...
from griffin.config.utils import EDIT_EXTENSIONS
...
class IconManager():
    ...
    def __init__(self):
        self.MAIN_FG_COLOR = GriffinPalette.ICON_1
        ...
        self._qtaargs = {
            ...
            'no_matches':              [('mdi.do-not-disturb',), {'color': GriffinPalette.COLOR_WARN_2}],
            ...
            'run_small':               [('mdi.play',), {'color': GriffinPalette.ICON_3}],
            'stop':                    [('mdi.stop',), {'color': GriffinPalette.COLOR_ERROR_1}],
            ...
            'breakpoint_transparent':  [('mdi.checkbox-blank-circle',), {'color': GriffinPalette.COLOR_ERROR_1, 'opacity': 0.75, 'scale_factor': 0.9}],
            'breakpoint_big':          [('mdi.checkbox-blank-circle',), {'color': GriffinPalette.ICON_4, 'scale_factor': 0.9} ],
            'breakpoint_cond_big':     [('mdi.help-circle',), {'color': GriffinPalette.ICON_4, 'scale_factor': 0.9},],
            'breakpoints':             [('mdi.dots-vertical',), {'color': self.MAIN_FG_COLOR}],
            'arrow_debugger':          [('mdi.arrow-right-bold',), {'color': GriffinPalette.ICON_2, 'scale_factor': 1.5}],
            'arrow-step-over':         [('mdi.debug-step-over',), {'color': GriffinPalette.ICON_2}],
            'arrow-continue':          [('mdi.fast-forward',), {'color': GriffinPalette.ICON_2}],
            'arrow-step-in':           [('mdi.debug-step-into',), {'color': GriffinPalette.ICON_2}],
            'arrow-step-out':          [('mdi.debug-step-out',), {'color': GriffinPalette.ICON_2}],
            'stop_debug':              [('mdi.stop',), {'color': GriffinPalette.ICON_2}],
            'run':                     [('mdi.play',), {'color': GriffinPalette.ICON_3}],
            'todo_list':               [('mdi.check-bold',), {'color': self.MAIN_FG_COLOR}],
            'wng_list':                [('mdi.alert',), {'options': [{'color': GriffinPalette.COLOR_WARN_2, 'color_disabled': GriffinPalette.COLOR_TEXT_4}]}],
            'prev_wng':                [('mdi.arrow-left',), {'options': [{'color': GriffinPalette.ICON_1, 'color_disabled': GriffinPalette.COLOR_TEXT_4}]}],
            'next_wng':                [('mdi.arrow-right',), {'options': [{'color': GriffinPalette.ICON_1, 'color_disabled': GriffinPalette.COLOR_TEXT_4}]}],
            ...
            'error':                   [('mdi.close-circle',), {'color': GriffinPalette.COLOR_ERROR_1}],
            'warning':                 [('mdi.alert',), {'color': GriffinPalette.COLOR_WARN_2}],
            'information':             [('mdi.information-outline',), {'color': GriffinPalette.GROUP_9}],
            'hint':                    [('mdi.lightbulb',), {'color': GriffinPalette.GROUP_9}],
            'todo':                    [('mdi.check-bold',), {'color': GriffinPalette.GROUP_9}],
            'ipython_console':         [('mdi.console',), {'color': self.MAIN_FG_COLOR}],
            'python':                  [('griffin.python-logo-up', 'griffin.python-logo-down'), {'options': [{'color': GriffinPalette.PYTHON_LOGO_UP}, {'color': GriffinPalette.PYTHON_LOGO_DOWN}]}],
            'pythonpath':              [('griffin.python-logo-up', 'griffin.python-logo-down'), {'options': [{'color': GriffinPalette.PYTHON_LOGO_UP}, {'color': GriffinPalette.PYTHON_LOGO_DOWN}]}],
            ...
            'question_tip':            [('mdi.help-circle-outline',), {'color': GriffinPalette.COLOR_BACKGROUND_6}],
            'question_tip_hover':      [('mdi.help-circle-outline',), {'color': GriffinPalette.COLOR_TEXT_4}],
            'info_tip':                [('mdi.information-outline',), {'color': GriffinPalette.COLOR_BACKGROUND_6}],
            'info_tip_hover':          [('mdi.information-outline',), {'color': GriffinPalette.COLOR_TEXT_4}],
            ...
            'griffin':                  [('griffin.griffin-logo-background', 'griffin.griffin-logo-web', 'griffin.griffin-logo-snake'),  {'options': [{'color': GriffinPalette.GRIFFIN_LOGO_BACKGROUND}, {'color': GriffinPalette.GRIFFIN_LOGO_WEB}, {'color': GriffinPalette.GRIFFIN_LOGO_SNAKE}]}],
            ...
            'vcs_commit':              [('mdi.source-commit',), {'color': GriffinPalette.ICON_3}],
            'vcs_browse':              [('mdi.source-repository',), {'color': GriffinPalette.ICON_3}],
            ...
            'convention':              [('mdi.alpha-c-circle',), {'color': GriffinPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'refactor':                [('mdi.alpha-r-circle',), {'color': GriffinPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            ...
            'inapp_appeal':            [('mdi6.heart',), {'color': GriffinPalette.COLOR_HEART}],
            # --- Autocompletion/document symbol type icons --------------
            'completions':             [('mdi.code-tags-check',), {'color': self.MAIN_FG_COLOR}],
            'keyword':                 [('mdi.alpha-k-box',), {'color': GriffinPalette.GROUP_9, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'color':                   [('mdi.alpha-c-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'enum':                    [('mdi.alpha-e-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'value':                   [('mdi.alpha-v-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'constant':                [('mdi.alpha-c-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'unit':                    [('mdi.alpha-u-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            ...
            'snippet':                 [('mdi.alpha-s-box',), {'color': GriffinPalette.GROUP_11, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'attribute':               [('mdi.alpha-a-box',), {'color': GriffinPalette.GROUP_12, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'reference':               [('mdi.alpha-r-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'variable':                [('mdi.alpha-v-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'field':                   [('mdi.alpha-a-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'property':                [('mdi.alpha-p-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'module':                  [('mdi.alpha-m-box',), {'color': GriffinPalette.GROUP_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'namespace':               [('mdi.alpha-n-box',), {'color': GriffinPalette.GROUP_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'package':                 [('mdi.alpha-p-box',), {'color': GriffinPalette.GROUP_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'class':                   [('mdi.alpha-c-box',), {'color': GriffinPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'interface':               [('mdi.alpha-i-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'string':                  [('mdi.alpha-s-box',), {'color': GriffinPalette.GROUP_9, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'number':                  [('mdi.alpha-n-box',), {'color': GriffinPalette.GROUP_9, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'boolean':                 [('mdi.alpha-b-box',), {'color': GriffinPalette.GROUP_12, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'array':                   [('mdi.alpha-a-box',), {'color': GriffinPalette.GROUP_9, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'object':                  [('mdi.alpha-o-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'key':                     [('mdi.alpha-k-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'null':                    [('mdi.alpha-n-box',), {'color': GriffinPalette.GROUP_12, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'enum_member':             [('mdi.alpha-e-box',), {'color': GriffinPalette.COLOR_ERROR_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'struct':                  [('mdi.alpha-s-box',), {'color': GriffinPalette.ICON_2, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'event':                   [('mdi.alpha-e-box',), {'color': GriffinPalette.COLOR_WARN_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'operator':                [('mdi.alpha-o-box',), {'color': GriffinPalette.COLOR_WARN_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'type_parameter':          [('mdi.alpha-t-box',), {'color': GriffinPalette.COLOR_WARN_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'private2':                [('mdi.eye-off',), {'color': GriffinPalette.COLOR_ERROR_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            'private1':                [('mdi.eye-off',), {'color': GriffinPalette.COLOR_ERROR_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            'method':                  [('mdi.alpha-m-box',), {'color': GriffinPalette.ICON_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'constructor':             [('mdi.alpha-c-box',), {'color': GriffinPalette.ICON_5, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'function':                [('mdi.alpha-f-box',), {'color': GriffinPalette.COLOR_WARN_3, 'scale_factor': self.BIG_ATTR_FACTOR}],
            'blockcomment':            [('mdi.pound',), {'color': GriffinPalette.ICON_2, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            'cell':                    [('mdi.percent',), {'color':GriffinPalette.GROUP_9, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            'no_match':                [('mdi.checkbox-blank-circle',), {'color': GriffinPalette.GROUP_3, 'scale_factor': self.SMALL_ATTR_FACTOR}],
            ...
            'griffin.example':          [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
            'griffin.autopep8':         [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
            'griffin.memory_profiler':  [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
            'griffin.line_profiler':    [('mdi.eye',), {'color': self.MAIN_FG_COLOR}],
            ...
            'dependency_ok':           [('mdi.check',), {'color': GriffinPalette.COLOR_SUCCESS_2}],
            'dependency_warning':      [('mdi.alert',), {'color': GriffinPalette.COLOR_WARN_2}],
            'dependency_error':        [('mdi.alert',), {'color': GriffinPalette.COLOR_ERROR_1}],
    ...
    def get_icon(self, name, resample=False):
        ...
        resample: bool
            ...
            platforms due to a Qt bug. See griffin-ide/griffin#1314.
        """
        # Icon image path
        ...
        if resample:
            # This only applies to the Griffin 2 icons
            ...
            # Fixes griffin-ide/griffin#19520
            ...
            disabled_color = QColor(GriffinPalette.COLOR_DISABLED)
        ...
        if theme == 'griffin 3':
            try:
                ...
                if not self._resource['loaded']:
                    qta.load_font('griffin', 'griffin.ttf', 'griffin-charmap.json',
                                directory=self._resource['directory'])
                    self._resource['loaded'] = True
                args, kwargs = self._qtaargs[name]
                if scale_factor is not None:
                    kwargs['scale_factor'] = scale_factor
                kwargs['color_disabled'] = GriffinPalette.COLOR_DISABLED
    ...
    def get_icon_by_extension_or_type(self, fname, scale_factor):
        ...
        # check for this.
        # Fixes griffin-ide/griffin#21304
        try:
        ...
        if osp.isdir(fname):
            ...
            if extension in self.OFFICE_FILES:
                ...
                if extension == '.ipynb':
                    ...
                    try:
                        # Fix for griffin-ide/griffin#5080. Even though
