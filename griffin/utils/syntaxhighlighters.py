...
from griffin.plugins.editor.utils.languages import CELL_LANGUAGES
from griffin.plugins.editor.utils.editor import TextBlockHelper as tbh
from griffin.plugins.editor.utils.editor import BlockUserData
from griffin.utils.workers import WorkerManager
from griffin.plugins.outlineexplorer.api import OutlineExplorerData
...
def get_color_scheme(name):
    ...
    for key in COLOR_SCHEME_KEYS:
        try:
            ...
            scheme[key] = CONF.get('appearance', 'griffin/'+key)
    return scheme
...
class BaseSH(QSyntaxHighlighter):
    ...
    def __init__(self, parent, font=None, color_scheme='Griffin'):
    ...
    def highlightBlock(self, text):
        ...
        :func:`griffin.utils.syntaxhighplighters.SyntaxHighlighter.highlight_block`.
...
class PygmentsSH(BaseSH):
    ...
    NORMAL = 0
    def __init__(self, parent, font=None, color_scheme=None):
        # Map Pygments tokens to Griffin tokens
    ...
    def _make_charlist(self, tokens, tokmap, formats):
        ...
        Griffin token type attached.  Stores this list as self._charlist.
        ...
        def _get_fmt(typ):
            """Get the Griffin format code for the given Pygments token type."""
            # Exact matches first
            if typ in tokmap:
                return tokmap[typ]
