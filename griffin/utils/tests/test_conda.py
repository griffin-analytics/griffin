...
from griffin.plugins.ipythonconsole.tests.conftest import get_conda_test_env
from griffin.utils.conda import (
    find_conda,
    get_conda_root_prefix,
    get_list_conda_envs,
    get_list_conda_envs_cache,
    get_griffin_conda_channel,
)
...
@pytest.mark.skipif(not running_in_ci(), reason="Only meant for CIs")
def test_get_griffin_conda_channel():
    channel, channel_url = get_griffin_conda_channel()
    assert channel == "pypi"
