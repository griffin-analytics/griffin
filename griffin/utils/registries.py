...
"""Griffin global registries for actions, toolbuttons, toolbars and menus."""
...
class GriffinRegistry:
    """General registry for global references (per plugin) in Griffin."""
    ...
    def register_reference(self, obj: Any, id_: str,
        ...
        plugin: Optional[str]
            ...
            :class:`griffin.api.plugins.Plugins`. If None, then the object will
            be stored under the global `main` key.
        context: Optional[str]
            Additional key used to store and identify the object reference.
            In any Griffin plugin implementation, this context may refer to an
    ...
    def __str__(self) -> str:
        return f'GriffinRegistry[{self.obj_type}, {self.registry_map}]'


ACTION_REGISTRY = GriffinRegistry('create_action', 'GriffinAction')
TOOLBUTTON_REGISTRY = GriffinRegistry('create_toolbutton', 'QToolButton')
TOOLBAR_REGISTRY = GriffinRegistry('create_toolbar', 'QToolBar')
MENU_REGISTRY = GriffinRegistry('create_menu', 'GriffinMenu')
