# -*- coding: utf-8 -*-
# -----------------------------------------------------------------------------
# Copyright (c) 2009- Griffin Project Contributors and others (see LICENSE.txt)
#
...
"""
griffin.utils.external
=====================

* Libraries or modules taken from external projects verbatim.
* Griffin developers can modify these modules to make them work
