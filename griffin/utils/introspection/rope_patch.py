...
[1] For compatibility with Griffin's standalone version, built with py2exe or
    cx_Freeze
...
def apply():
    ...
    #     distributions
    from griffin.config.base import is_py2exe_or_cx_Freeze
    if is_py2exe_or_cx_Freeze():
        ...
        class PatchedProject(project.Project):
            def _default_config(self):
                ...
                fname = get_module_source_path('griffin',
                                               'default_config.py')
    ...
    class PatchedPyDocExtractor(codeassist.PyDocExtractor):
        ...
        def get_doc(self, pyobject):
            ...
            elif pyobject.get_doc() is not None:  # Griffin patch
                return self._trim_docstring(pyobject.get_doc())
            return None
