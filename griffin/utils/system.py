...
if __name__ == '__main__':
    print("*"*80)  # griffin: test-skip
    print(memory_usage.__doc__)  # griffin: test-skip
    print(memory_usage())  # griffin: test-skip
    if os.name == 'nt':
        #  windll can only be imported if os.name = 'nt' or 'ce'
        print("*"*80)  # griffin: test-skip
        print(windows_memory_usage.__doc__)  # griffin: test-skip
        print(windows_memory_usage())  # griffin: test-skip
