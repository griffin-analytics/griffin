...
from griffin.plugins.explorer.widgets.main_widget import ExplorerWidget
from griffin.plugins.explorer.confpage import ExplorerConfigPage


class Explorer(GriffinDockablePlugin):
    ...
    """
    This signal is emitted to request creating a new file with Griffin.
