...
# Local imports
from griffin.plugins.explorer.widgets.main_widget import FileExplorerTest
from griffin.plugins.projects.widgets.main_widget import ProjectExplorerTest
...
def test_single_click_to_open(qtbot, file_explorer):
    ...
    def run_test_helper(single_click, initial_index):
        ...
        for __ in range(4):  # 4 items inside `/griffin/plugins/explorer/`
...
def test_update_filters(file_explorer, qtbot):
    ...
    This is a regression test for griffin-ide/griffin#14328
    """
