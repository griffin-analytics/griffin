...
from griffin_kernels.utils.pythonenv import get_env_dir
...
from griffin.utils.envs import get_list_envs
from griffin.utils.misc import get_python_executable
from griffin.utils.programs import get_interpreter_info
...
class MainInterpreterContainer(PluginMainContainer):
    ...
    envs: dict
        ...
        :py:meth:`griffin.utils.envs.get_list_envs`.
    """
    ...
    def _finish_updating_envs(self, worker, output, error):
        ...
        # proper output.
        # Fixes griffin-ide/griffin#20539
        ...
        with QMutexLocker(self._lock):
            ...
            try:
                ...
                if (
                    ...
                    # For our installers
                    or (is_conda_based_app() and "griffin-runtime" in path)
                ):
                    name = 'Conda: ' + env_name
                elif 'pyenv' in path:
                    name = 'Pyenv: ' + env_name
