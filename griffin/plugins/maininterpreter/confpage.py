...
from griffin.utils.conda import get_list_conda_envs_cache
from griffin.utils.misc import get_python_executable
from griffin.utils.pyenv import get_list_pyenv_envs_cache
...
class MainInterpreterConfigPage(PluginConfigPage):
    ...
    def __init__(self, plugin, parent):
        ...
        # check if the executable is valid - use Griffin's if not
    ...
    def setup_page(self):
        ...
        self.def_exec_radio = self.create_radiobutton(
            _("Internal (i.e. the same used by Griffin)"),
            'default',
        ...
        umr_enabled_box = newcb(
            ...
            msg_warning=_(
                ...
                "Python file using the Griffin's builtin function "
                "<b>runfile</b>."
    ...
    def warn_python_compatibility(self, pyexec):
        ...
        griffin_version = sys.version_info[0]
        try:
            ...
            console_version = griffin_version
        except ValueError:
            return False

        if griffin_version != console_version:
            QMessageBox.warning(
                self,
                _('Warning'),
                _("You selected a <b>Python %d</b> interpreter for the "
                  "console but Griffin is running on <b>Python %d</b>!.<br><br>"
                  "Although this is possible, we recommend you to install and "
                  "run Griffin directly with your selected interpreter, to "
