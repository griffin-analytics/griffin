...
from griffin.plugins.mainmenu.api import ApplicationMenus, SourceMenuSections
from griffin.plugins.pylint.confpage import PylintConfigPage
from griffin.plugins.pylint.main_widget import PylintWidget
...
class Pylint(GriffinDockablePlugin, RunExecutor):
