...
from griffin.plugins.pylint.utils import get_pylintrc_path
from griffin.plugins.variableexplorer.widgets.texteditor import TextEditor
from griffin.utils.icon_manager import ima
from griffin.utils.misc import getcwd_or_home, get_home_dir
...
from griffin.widgets.onecolumntree import OneColumnTree, OneColumnTreeActions
...
DANGER_COLOR = GriffinPalette.COLOR_ERROR_1
WARNING_COLOR = GriffinPalette.COLOR_WARN_1
SUCCESS_COLOR = GriffinPalette.COLOR_SUCCESS_1


# TODO: There should be some palette from the appearance plugin so this
# is easier to use
MAIN_TEXT_COLOR = GriffinPalette.COLOR_TEXT_1
MAIN_PREVRATE_COLOR = GriffinPalette.COLOR_TEXT_1
...
class PylintWidget(PluginMainWidget):
    ...
    def _start(self):
        ...
        pythonpath_manager_values = self.get_conf(
            'griffin_pythonpath', default=[], section='pythonpath_manager'
        )
    ...
    def set_filename(self, filename):
        ...
        # Fixes griffin-ide/griffin#13347
