...
from griffin.py3compat import is_text_string, qbytearray_to_str
...
class BasePluginMixin(object):
    """Implementation of the basic functionality for Griffin plugins."""
...
class PluginWindow(QMainWindow):
    """MainWindow subclass that contains a Griffin Plugin."""
...
class BasePluginWidgetMixin(object):
    """
    Implementation of the basic functionality for Griffin plugin widgets.
    """
    ...
    def _initialize_plugin_in_mainwindow_layout(self):
        ...
        initialize plugin position in Griffin's window layout.
    ...
    def _create_dockwidget(self):
        ...
        dock = GriffinDockWidget(self.get_plugin_title(), self.main)
    ...
    def set_plugin_font(self):
        ...
        Note: All plugins in Griffin use a global font. To define a different
