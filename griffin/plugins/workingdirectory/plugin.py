...
from griffin.plugins.workingdirectory.confpage import WorkingDirectoryConfigPage
from griffin.plugins.workingdirectory.container import (
    WorkingDirectoryContainer)
from griffin.plugins.toolbar.api import ApplicationToolbars
from griffin.utils import encoding


class WorkingDirectory(GriffinPluginV2):
    """
    ...
    @staticmethod
    def get_description():
        return _("Manage the current working directory used in Griffin.")
    ...
    def chdir(self, directory, sender_plugin=None):
        ...
        sender_plugin: griffin.api.plugins.GriffinPluginsV2
        ...
        # Fixes griffin-ide/griffin#23866
        if run:
    ...
    def load_history(self, workdir=None):
        """
        Load history from a text file located in Griffin configuration folder
    ...
    def save_history(self):
        """
        Save history to a text file located in Griffin configuration folder.
        """
