...
from griffin.api.utils import ABCMeta, abstract_attribute

if typing.TYPE_CHECKING:
    from griffin.plugins.remoteclient.api import GriffinRemoteAPIManager


GriffinBaseJupyterAPIType = typing.TypeVar(
    "GriffinBaseJupyterAPIType", bound="GriffinBaseJupyterAPI"
)
...
class GriffinBaseJupyterAPI(metaclass=ABCMeta):
    """
    ...
    def __init__(self, manager: GriffinRemoteAPIManager):
