...
from griffin.plugins.remoteclient.api.modules.base import GriffinBaseJupyterAPI
from griffin.plugins.remoteclient.api import GriffinRemoteAPIManager

# jupyter server's extension name for griffin-remote-services
GRIFFIN_PLUGIN_NAME = "griffin-services"


class GriffinServicesError(Exception):
    """
    Exception for errors related to Griffin services.
    """
    ...


class RemoteFileServicesError(GriffinServicesError):
    """
...
@GriffinRemoteAPIManager.register_api
class GriffinRemoteFileIOAPI(GriffinBaseJupyterAPI, RawIOBase):
    """
    ...
    """
    base_url = GRIFFIN_PLUGIN_NAME + "/fs/open"
...
@GriffinRemoteAPIManager.register_api
class GriffinRemoteFileServicesAPI(GriffinBaseJupyterAPI):
    """
    ...
    base_url = GRIFFIN_PLUGIN_NAME + "/fs"
