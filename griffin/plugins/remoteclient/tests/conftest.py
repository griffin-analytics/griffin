...
"""Fixtures for the Griffin Remote Client plugin tests."""
...
from griffin.plugins.remoteclient.plugin import RemoteClient
...
def remote_client_id(
    ...
    """Add the Griffin Remote Client plugin to the registry."""
    ssh_options = {
...
def remote_client(
    ...
    """
    Start the Griffin Remote Client plugin.

    Yields
    ------
        RemoteClient: Griffin Remote Client plugin.
    """
...
def ipyconsole_and_remoteclient(
    ...
    """
    Start the Griffin Remote Client plugin with IPython Console.

    Yields
    ------
        tuple: IPython Console and Griffin Remote Client plugins
    """
...
def ssh_server_addr(
    ...
    port = docker_services.port_for("test-griffin-remote-server", 22)
