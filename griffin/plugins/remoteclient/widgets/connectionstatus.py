...
from griffin.plugins.remoteclient.api import MAX_CLIENT_MESSAGES
...
STATUS_TO_COLOR = {
    ConnectionStatus.Inactive: GriffinPalette.COLOR_OCCURRENCE_5,
    ConnectionStatus.Connecting: GriffinPalette.COLOR_WARN_4,
    ConnectionStatus.Active: GriffinPalette.COLOR_SUCCESS_3,
    ConnectionStatus.Stopping: GriffinPalette.COLOR_WARN_4,
    ConnectionStatus.Error: GriffinPalette.COLOR_ERROR_2,
}
...
class ConnectionStatusWidget(
    ...
    def _set_stylesheet(self):
        ...
        font_size = self.get_font(GriffinFontType.Interface).pointSize()
        ...
        self._log_widget.css.QPlainTextEdit.setValues(
            ...
            borderLeft=f"1px solid {GriffinPalette.COLOR_BACKGROUND_3}",
            borderRight=f"1px solid {GriffinPalette.COLOR_BACKGROUND_3}",
            borderBottom=f"1px solid {GriffinPalette.COLOR_BACKGROUND_3}",
