...
from griffin.plugins.remoteclient.widgets import AuthenticationMethod
from griffin.plugins.remoteclient.widgets.connectionstatus import (
...
from griffin.widgets.config import GriffinConfigPage
from griffin.widgets.helperwidgets import TipWidget
from griffin.widgets.sidebardialog import SidebarDialog
...
class ValidationLabel(QLabel):
    ...
    def __init__(self, parent):
        ...
        css.QLabel.setValues(
            ...
            # them (see GriffinConfigPage.create_lineedit).
...
# ---- Pages
# =============================================================================
class BaseConnectionPage(GriffinConfigPage, GriffinFontsMixin):
    ...
    def create_connection_info_widget(self):
        ...
        if self.NEW_CONNECTION:
            ...
            intro_tip_text = _(
                "Griffin will use this connection to start remote kernels in "
                "the IPython Console. This allows you to use Griffin locally "
            ...
            font = self.get_font(GriffinFontType.Interface)
    ...
    def _create_password_subpage(self):
        ...
        password = self.create_lineedit(
            ...
            tip=(
                _("Your password will be saved securely by Griffin")
                if self.NEW_CONNECTION
                else _("Your password is saved securely by Griffin")
            ),
            status_icon=ima.icon("error"),
            password=True
        )
    ...
    def _create_keyfile_subpage(self):
        ...
        passpharse = self.create_lineedit(
            ...
            tip=(
                _("Your passphrase will be saved securely by Griffin")
                if self.NEW_CONNECTION
                else _("Your passphrase is saved securely by Griffin")
            ),
            password=True
        )
...
class ConnectionDialog(SidebarDialog):
    ...
    def create_buttons(self):
        bbox = GriffinDialogButtonBox(QDialogButtonBox.Cancel)
