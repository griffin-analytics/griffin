...
from griffin.plugins.shortcuts.confpage import ShortcutsConfigPage
from griffin.plugins.shortcuts.utils import (
    ShortcutData,
    SHORTCUTS_FOR_WIDGETS_DATA,
)
from griffin.plugins.shortcuts.widgets.summary import ShortcutsSummaryDialog
from griffin.utils.qthelpers import add_shortcut_to_tooltip, GriffinAction
...
# --- Plugin
# ----------------------------------------------------------------------------
class Shortcuts(GriffinPluginV2, GriffinShortcutsMixin):
    """
    Shortcuts Plugin.
    """
    ...
    def get_shortcut_data(self):
        ...
        # mechanism (see GriffinShortcutsMixin.register_shortcut_for_widget).
    ...
    def register_shortcut(self, qaction_or_qshortcut, context, name,
        ...
        """
        Register QAction or QShortcut to Griffin main application,
    ...
    def unregister_shortcut(self, qaction_or_qshortcut, context, name,
                            add_shortcut_to_tip=True, plugin_name=None):
        """
        Unregister QAction or QShortcut from Griffin main application.
        """
        # Name and context are saved in lowercase in our config system, so we
        # need to use them like that here.
        # Note: That's how the Python ConfigParser class saves options.
    ...
    def apply_shortcuts(self):
        ...
        for index, data in enumerate(self._shortcut_data):
            ...
            if (
                ...
                and isinstance(data.qobject, GriffinAction)
            ):
                keyseq = QKeySequence()
