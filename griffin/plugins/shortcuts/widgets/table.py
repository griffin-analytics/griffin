...
from griffin.plugins.shortcuts.utils import ShortcutData
...
from griffin.utils.stringmatching import get_search_regex, get_search_scores
from griffin.widgets.helperwidgets import (
    HTMLDelegate,
    HoverRowsTableView,
    VALID_FINDER_CHARS,
)
...
class ShortcutEditor(QDialog):
    ...
    def reject(self):
        ...
        # Added for griffin-ide/griffin#5426.  Due to the focusPolicy of
    ...
    def event(self, event):
        ...
        # See griffin-ide/griffin/issues/10786.
...
class Shortcut(GriffinShortcutsMixin):
...
class ShortcutsModel(QAbstractTableModel):
    def __init__(self, parent):
        ...
        self.text_color_highlight = GriffinPalette.COLOR_TEXT_1
