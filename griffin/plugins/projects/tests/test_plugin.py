...
import griffin.plugins.base
from griffin.plugins.preferences.tests.conftest import MainWindowMock
from griffin.plugins.projects.api import BaseProjectType
from griffin.plugins.projects.plugin import Projects
from griffin.plugins.projects.widgets.main_widget import QMessageBox
...
def projects(qtbot, mocker, request, tmpdir):
    ...
    mocker.patch.object(griffin.plugins.base.GriffinDockWidget,
...
def test_switch_to_plugin(projects, tmpdir, value):
    ...
    Regression test for griffin-ide/griffin#12491."""
    projects.set_conf('visible_if_project_open', value)
    projects.open_project(path=to_text_string(tmpdir))
...
def test_set_get_project_filenames_when_closing_no_files(create_projects,
    ...
    Regression test for griffin-ide/griffin#10045.
    """
...
def test_set_get_project_filenames_when_closing(create_projects, tmpdir):
    ...
    Regression test for griffin-ide/griffin#8375.
    Updated for griffin-ide/griffin#10045.
    """
...
def test_recent_projects_menu_action(projects, tmpdir):
    ...
    Regression test for griffin-ide/griffin#8450.
    """
...
def test_project_explorer_tree_root(projects, tmpdir, qtbot):
    ...
    Regression test for griffin-ide/griffin#8455.
    """
    ...
    if os.name == 'nt':
        ...
        # pass for Python2 in Windows, see griffin-ide/griffin#8528.
        import win32file
...
def test_reopen_project(projects, tmpdir):
    ...
    last_project.mkdir('.griffinproject')
...
def test_recreate_project_config(projects, tmpdir):
    ...
    Regression test for griffin-ide/griffin#17907.
    """
