...
from griffin.config.base import _, get_home_dir
...
class ProjectDialog(QDialog):
    ...
    def __init__(self, parent, project_types):
        ...
        # Widgets
        projects_url = "http://docs.griffin-ide.org/current/panes/projects.html"
        self.description_label = QLabel(
            _("Select a new or existing directory to create a new Griffin "
        ...
        self.combo_project_type = GriffinComboBox()
        ...
        self.bbox = GriffinDialogButtonBox(orientation=Qt.Horizontal)
    ...
    def update_location(self, text=''):
        ...
        if name and self.radio_new_dir.isChecked():
            ...
            # Griffin projects.
            path = self.location
            path_validation = not osp.isdir(osp.join(path, '.griffinproject'))
            if not path_validation:
                msg = _("This directory is already a Griffin project!")
        ...
        # Fixes griffin-ide/griffin#16745
        if validated:
