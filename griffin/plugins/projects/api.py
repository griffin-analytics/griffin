...
from griffin.config.base import get_project_config_folder
from griffin.plugins.projects.utils.config import (ProjectMultiConfig,
                                                  PROJECT_NAME_MAP,
                                                  PROJECT_DEFAULTS,
...
class BaseProjectType:
    ...
    def __init__(self, root_path, parent_plugin=None):
        ...
        # config files.
        # Fixes griffin-ide/griffin#17907
        try:
    ...
    def get_recent_files(self):
        ...
        # Check if recent_files in [main] (Griffin 4)
        recent_files = self.get_option("recent_files", 'main', [])
        if recent_files:
            # Move to [workspace] (Griffin 5)
