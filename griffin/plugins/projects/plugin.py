...
from griffin.plugins.completion.api import WorkspaceUpdateKind
from griffin.plugins.mainmenu.api import ApplicationMenus, ProjectsMenuSections
from griffin.plugins.projects.api import EmptyProject
from griffin.plugins.projects.widgets.main_widget import (
...
class Projects(GriffinDockablePlugin):
    """Projects plugin."""
    ...
    @staticmethod
    def get_description():
        return _("Create Griffin projects and manage their files.")

    @classmethod
    def get_icon(cls):
        return cls.create_icon('project_griffin')

    def on_initialize(self):
        """Register plugin in Griffin's main window"""
    ...
    def on_mainwindow_visible(self):
        ...
        # Fixes griffin-ide/griffin#23497
    ...
    def open_project(self, path=None, project_type=None, restart_console=True,
        ...
        project_type: griffin.plugins.projects.api.BaseProjectType, optional
            Project type class.
