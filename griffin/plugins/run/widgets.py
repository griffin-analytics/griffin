...
from griffin.config.base import running_in_ci, running_under_pytest
...
from griffin.widgets.collapsible import CollapsibleWidget
...
class BaseRunConfigDialog(QDialog):
    ...
    def add_button_box(self, stdbtns):
        ...
        self.bbox = GriffinDialogButtonBox(stdbtns)
...
class ExecutionParametersDialog(BaseRunConfigDialog):
    ...
    def accept(self) -> None:
        ...
        # Fixes griffin-ide/griffin#22649
...
class RunDialog(BaseRunConfigDialog, GriffinFontsMixin):
    ...
    def setup(self):
        ...
        self.parameters_combo = GriffinComboBox(self)
    ...
    def showEvent(self, event):
        ...
        if not self._is_shown:
            ...
            header_font = (
                self.get_font(GriffinFontType.Interface, font_size_delta=1)
            )
