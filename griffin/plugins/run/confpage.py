...
from griffin.widgets.helperwidgets import HoverRowsTableView
    ...
    def setup_page(self):
        ...
        about_label = QLabel(
            _(
                ...
                "different runners that can execute files in Griffin."
            )
        )
