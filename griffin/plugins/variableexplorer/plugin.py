...
from griffin.plugins.variableexplorer.confpage import (
    VariableExplorerConfigPage)
from griffin.plugins.variableexplorer.widgets.main_widget import (
    VariableExplorerWidget)


class VariableExplorer(GriffinDockablePlugin, ShellConnectPluginMixin):
    """
    Variable explorer plugin.
    """
