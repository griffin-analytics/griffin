...
from griffin.py3compat import INT_TYPES, TEXT_TYPES, to_text_string
...
def get_color(value, alpha):
    ...
    colors = {
        bool: GriffinPalette.GROUP_1,
        tuple([float] + list(INT_TYPES)): GriffinPalette.GROUP_2,
        TEXT_TYPES: GriffinPalette.GROUP_3,
        datetime.date: GriffinPalette.GROUP_4,
        list: GriffinPalette.GROUP_5,
        set: GriffinPalette.GROUP_6,
        tuple: GriffinPalette.GROUP_7,
        dict: GriffinPalette.GROUP_8,
        np.ndarray: GriffinPalette.GROUP_9,
    }
...
class PreviewTableModel(QAbstractTableModel):
    ...
    def parse_data_type(self, index, **kwargs):
        ...
        try:
            ...
            print(instance)  # griffin: test-skip
...
class PreviewTable(QTableView):
    ...
    def __init__(self, parent):
        ...
        self.opt_menu = GriffinMenu(self)
...
def test(text):
    ...
    if dialog.exec_():
        print(dialog.get_data())  # griffin: test-skip
