...
from griffin.plugins.variableexplorer.widgets.objectexplorer.utils import (
    cut_off_str)
from griffin.plugins.variableexplorer.widgets.objectexplorer.tree_item import (
    TreeItem)
...
class TreeModel(QAbstractItemModel, GriffinFontsMixin):
    """
    ...
    def __init__(self,
        ...
        self.regular_font = self.get_font(GriffinFontType.MonospaceInterface)
    ...
    def _fetchObjectChildren(self, obj, obj_path):
        ...
        # Related with griffin-ide/griffin#6728 and griffin-ide/griffin#9959
