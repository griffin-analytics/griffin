...
from griffin.plugins.variableexplorer.widgets.objectexplorer import (
...
class ObjectExplorer(BaseDialog, GriffinFontsMixin, GriffinWidgetMixin):
...
def test():
    ...
    import datetime
    import numpy as np
    from griffin.pil_patch import Image
