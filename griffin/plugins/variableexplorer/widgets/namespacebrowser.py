...
from griffin.widgets.collectionseditor import RemoteCollectionsEditorTableView
from griffin.plugins.variableexplorer.widgets.importwizard import ImportWizard
from griffin.utils import encoding
from griffin.utils.misc import getcwd_or_home, remove_backslashes
from griffin.widgets.helperwidgets import FinderWidget, PaneEmptyWidget
...
class NamespaceBrowser(QWidget, GriffinWidgetMixin):
    """
    ...
    def update_view(self, kernel_state):
        ...
        kernel_state: dict
            ...
            the `GriffinKernel.get_state` method of Griffin-kernels.
        """
    ...
    def refresh_namespacebrowser(self, *, interrupt=True):
        ...
        if not self.shellwidget.griffin_kernel_ready:
            return
    ...
    def load_data(self, filename, ext):
        ...
        try:
            ...
            msg = _("Griffin is unable to open the file "
            ...
            # Fixes griffin-ide/griffin#19126
            ...
            msg = _(
                "Griffin is unable to open the file you're trying to load. "
