...
from griffin_kernels.utils.nsview import value_to_display
from griffin_kernels.utils.lazymodules import numpy as np
...
from griffin.api.widgets.comboboxes import GriffinComboBox
...
from griffin.py3compat import (is_binary_string, is_string, is_text_string,
                              to_binary_string, to_text_string)
from griffin.utils.icon_manager import ima
from griffin.utils.qthelpers import keybinding, safe_disconnect
...
class ArrayModel(QAbstractTableModel, GriffinFontsMixin):
    """
    ...
    def __init__(self, data, format_spec=".6g", readonly=False, parent=None):
        ...
        # crashes. See: griffin-ide/griffin#8093
        self.has_inf = False
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        try:
            ...
            print("OverflowError: " + str(e))  # griffin: test-skip
            QMessageBox.critical(self.dialog, "Error",
...
class ArrayDelegate(QItemDelegate, GriffinFontsMixin):
...
class ArrayView(QTableView, GriffinWidgetMixin):
    """Array view class"""
...
class ArrayEditorWidget(QWidget):
    ...
    def __init__(self, parent, data, readonly=False):
        ...
        # a `str` for arrays with strings, see griffin-ide/griffin#22466
...
class ArrayEditor(BaseDialog, GriffinWidgetMixin):
    """Array Editor Dialog"""
    ...
    def setup_ui(self, title='', readonly=False):
        ...
        self.combo_box = GriffinComboBox(self)
    ...
    def set_data_and_check(self, data, readonly=False):
        ...
        # Fixes griffin-ide/griffin#20462
