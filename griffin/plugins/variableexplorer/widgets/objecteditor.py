...
from griffin_kernels.utils.nsview import is_known_type
...
def test():
    ...
    print(oedit(foobar, app=app))  # griffin: test-skip
    print(oedit(example, app=app))  # griffin: test-skip
    print(oedit(np.random.rand(10, 10), app=app))  # griffin: test-skip
    print(oedit(oedit.__doc__, app=app))  # griffin: test-skip
    print(example)  # griffin: test-skip
