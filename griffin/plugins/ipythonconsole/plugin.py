...
from griffin.plugins.ipythonconsole.confpage import IPythonConsoleConfigPage
from griffin.plugins.ipythonconsole.widgets.run_conf import IPythonConfigOptions
from griffin.plugins.ipythonconsole.widgets.main_widget import (
...
from griffin.plugins.editor.api.run import CellRun, FileRun, SelectionRun


class IPythonConsole(GriffinDockablePlugin, RunExecutor):
    """
    ...
    def update_font(self):
        ...
        app_font = self.get_font(GriffinFontType.Interface)
    ...
    # ---- Griffin Kernels handlers registry functionality
    def register_griffin_kernel_call_handler(self, handler_id, handler):
        ...
        handler_id : str
            ...
            call the respective handler in the Griffin kernel.
        handler : func
        ...
        None.
        """
        self.get_widget().register_griffin_kernel_call_handler(
            handler_id, handler)
    ...
    def unregister_griffin_kernel_call_handler(self, handler_id):
        ...
        handler_id : str
            ...
            from the Griffin kernel available handlers.

        Returns
        -------
        None.
        """
        self.get_widget().unregister_griffin_kernel_call_handler(handler_id)
    ...
    def rename_client_tab(self, client, given_name):
        ...
        Parameters
        ----------
        client: griffin.plugins.ipythonconsole.widgets.client.ClientWidget
            Client to rename.
        given_name: str
    ...
    def create_new_client(self, give_focus=True, filename='', special=None,
        ...
        path_to_custom_interpreter : str, optional
            ...
            the interpreter selected in Griffin Preferences.
            The default is None.
