...
from griffin.widgets.calltip import CallTipWidget
from griffin.widgets.mixins import (BaseEditMixin, GetHelpMixin,
                                   TracebackLinksMixin)
...
class ControlWidget(TracebackLinksMixin, GetHelpMixin,
    ...
    """
    Subclass of QTextEdit with features from Griffin's mixins to use as the
    ...
    def __init__(self, parent=None):
        ...
        # To not use Griffin calltips obtained through the monitor
        self.calltips = False
    ...
    def insert_horizontal_ruler(self):
        ...
        ruler.setBackground(QColor(GriffinPalette.COLOR_TEXT_1))
...
class PageControlWidget(QTextEdit, BaseEditMixin):
    """
    Subclass of QTextEdit with features from Griffin's mixins.BaseEditMixin to
