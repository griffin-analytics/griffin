...
class KernelConnectionDialog(QDialog, GriffinConfigurationAccessor):
    ...
    def __init__(self, parent=None):
        ...
        main_label = QLabel(_(
            ...
            "to them, see <a href=\"https://docs.griffin-ide.org/current/panes/"
        ...
        self.accept_btns = GriffinDialogButtonBox(
    ...
    def load_connection_settings(self):
        ...
        try:
            import keyring
            ssh_passphrase = keyring.get_password("griffin_remote_kernel",
                                                  "ssh_key_passphrase")
            ssh_password = keyring.get_password("griffin_remote_kernel",
                                                "ssh_password")
            if ssh_passphrase:
    ...
    def save_connection_settings(self):
        ...
        try:
            import keyring
            if is_ssh_key:
                keyring.set_password("griffin_remote_kernel",
                                     "ssh_key_passphrase",
                                     self.kfp.text())
            else:
                keyring.set_password("griffin_remote_kernel",
