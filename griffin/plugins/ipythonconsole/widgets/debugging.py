...
class GriffinIPy3Lexer(IPython3Lexer):
    ...
    tokens['root'] = griffin_tokens + tokens['root']
...
class DebuggingHistoryWidget(RichJupyterWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Fixes griffin-ide/griffin#18531
        try:
...
class DebuggingWidget(DebuggingHistoryWidget, GriffinConfigurationAccessor):
    """
    ...
    def _pdb_cmd_prefix(self):
        ...
        prefix = ''
        if self.griffin_kernel_ready and self.is_pdb_using_exclamantion_mark():
            prefix = '!'
        return prefix
    ...
    def _handle_input_request(self, msg):
        ...
        if not self.is_griffin_kernel and "ipdb>" in msg['content']['prompt']:
    ...
    def stop_debugging(self):
        """Stop debugging."""
        if self.griffin_kernel_ready and not self.is_waiting_pdb_input():
    ...
    def refresh_from_pdb(self, pdb_state):
        ...
        See publish_pdb_state and notify_griffin in griffin_kernels
        """
