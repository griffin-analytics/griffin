...
from griffin.plugins.debugger.plugin import Debugger
from griffin.plugins.help.utils.sphinxify import CSS_PATH
...
def ipyconsole(qtbot, request, tmpdir):
    ...
    console.register_griffin_kernel_call_handler('get_file_code', get_file_code)
    console.register_griffin_kernel_call_handler('run_cell', get_cell)
    ...
    try:
        if test_environment_interpreter:
            ...
            # might be displayed, so shell.griffin_kernel_ready will not be True
            qtbot.waitUntil(
