...
from griffin.plugins.updatemanager.widgets.status import UpdateManagerStatus
...
class UpdateManagerActions:
    GriffinCheckUpdateAction = "griffin_check_update_action"
...
class UpdateManagerContainer(PluginMainContainer):
    ...
    def setup(self):
        ...
        self.check_update_action = self.create_action(
            UpdateManagerActions.GriffinCheckUpdateAction,
            _("Check for updates..."),
    ...
    def on_close(self):
        ...
        # Run installer after Griffin is closed
