...
from griffin.utils.misc import get_python_executable, getcwd_or_home
from griffin.utils.palette import GriffinPalette
from griffin.utils.programs import shell_split
from griffin.utils.qthelpers import get_item_user_text, set_item_user_text
from griffin.widgets.comboboxes import PythonModulesComboBox
...
# --- Constants
# ----------------------------------------------------------------------------
MAIN_TEXT_COLOR = GriffinPalette.COLOR_TEXT_1
...
class ProfilerWidget(PluginMainWidget):
    ...
    @on_conf_change(section='pythonpath_manager', option='griffin_pythonpath')
...
class ProfilerDataTree(QTreeWidget, GriffinWidgetMixin):
    """
    ...
    def load_data(self, profdatafile):
        ...
        import pstats
        # Fixes griffin-ide/griffin#6220.
        try:
        ...
        if self.compare_file is not None:
            # Fixes griffin-ide/griffin#5587.
            try:
    ...
    def find_root(self):
        ...
        # Fixes griffin-ide/griffin#8336.
    ...
    def color_string(self, x):
        ...
        if len(x) == 2 and self.compare_file is not None:
            difference = x[0] - x[1]
            if difference:
                color, sign = ((GriffinPalette.COLOR_SUCCESS_1, '-')
                               if difference < 0
                               else (GriffinPalette.COLOR_ERROR_1, '+'))
