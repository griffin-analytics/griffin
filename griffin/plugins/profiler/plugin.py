...
from griffin.plugins.editor.api.run import FileRun
from griffin.plugins.mainmenu.api import ApplicationMenus, RunMenuSections
from griffin.plugins.profiler.api import ProfilerPyConfiguration
from griffin.plugins.profiler.confpage import ProfilerConfigPage
from griffin.plugins.profiler.widgets.main_widget import (
    ProfilerWidget, is_profiler_installed)
from griffin.plugins.profiler.widgets.run_conf import (
...
class Profiler(GriffinDockablePlugin, RunExecutor):
    """
