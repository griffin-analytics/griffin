...
from griffin.api.plugin_registration.decorators import (on_plugin_available,
                                                       on_plugin_teardown)
from griffin.plugins.switcher.api import SwitcherActions
from griffin.plugins.switcher.container import SwitcherContainer
from griffin.plugins.mainmenu.api import ApplicationMenus, FileMenuSections


class Switcher(GriffinPluginV2):
    """
    Switcher plugin.
    """
