...
from griffin.plugins.switcher.widgets.proxymodel import SwitcherProxyModel
from griffin.plugins.switcher.widgets.item import (
...
from griffin.widgets.helperwidgets import HTMLDelegate
from griffin.utils.stringmatching import get_search_scores
from griffin.plugins.switcher.utils import clean_string
...
class Switcher(QDialog, GriffinFontsMixin):
    """
    ...
    def __init__(self, parent, help_text=None):
        ...
        self._item_styles = {
            'title_color': GriffinPalette.COLOR_TEXT_1,
            'description_color': GriffinPalette.COLOR_TEXT_1,
            'section_color': GriffinPalette.TIP_TITLE_COLOR,
            'shortcut_color': GriffinPalette.COLOR_TEXT_1,
