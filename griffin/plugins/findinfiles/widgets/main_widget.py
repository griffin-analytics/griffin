...
from griffin.plugins.findinfiles.widgets.results_browser import (
    ON, ResultsBrowser)
...
class FindInFilesWidget(PluginMainWidget):
    ...
    # Other constants
    REGEX_INVALID = f"background-color:{GriffinPalette.COLOR_ERROR_2};"
