...
from griffin.plugins.findinfiles.widgets.search_thread import (
    ELLIPSIS, MAX_RESULT_LENGTH)
from griffin.utils import icon_manager as ima
from griffin.utils.palette import GriffinPalette
from griffin.utils.stylesheet import AppStyle
from griffin.widgets.onecolumntree import OneColumnTree
...
class FileMatchItem(QTreeWidgetItem):
    ...
    def __init__(self, parent, path, filename, sorting, text_color):
        ...
        # Fixes griffin-ide/griffin#17443 and griffin-ide/griffin#20964
        try:
...
class ItemDelegate(QStyledItemDelegate):
    ...
    def __init__(self, parent):
        ...
        self._margin = None
        self._background_color = QColor(GriffinPalette.COLOR_BACKGROUND_3)
        self.width = 0
...
class ResultsBrowser(OneColumnTree, GriffinFontsMixin):
    ...
    def __init__(self, parent, text_color, max_results=1000):
        ...
        self.completed = None
        self.sorting = {}
        self.font = self.get_font(GriffinFontType.MonospaceInterface)
        self.data = None
        self.files = None
        ...
        # For further information see griffin-ide/griffin#13178
