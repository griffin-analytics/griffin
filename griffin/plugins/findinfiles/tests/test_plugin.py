...
from griffin.plugins.findinfiles.plugin import FindInFiles
from griffin.plugins.findinfiles.widgets.combobox import SearchInComboBoxItems
...
def test_closing_plugin(findinfiles, qtbot, mocker, tmpdir):
    ...
    correctly from the griffin config file.
    """
