...
from griffin.plugins.preferences.widgets.configdialog import ConfigDialog
...
class PreferencesContainer(PluginMainContainer):
    ...
    def setup(self):
        ...
        self.reset_action = self.create_action(
            ...
            _("Reset Griffin to factory defaults"),
    ...
    def on_close(self):
        # Save dialog size to use it in the next Griffin session
