...
from griffin.api.plugins._old_api import GriffinPlugin
from griffin.api.plugin_registration.decorators import (
    on_plugin_available, on_plugin_teardown)
from griffin.api.plugin_registration.registry import PreferencesAdapter
from griffin.config.base import _, running_under_pytest
from griffin.config.main import CONF_VERSION
from griffin.config.user import NoDefault
from griffin.plugins.mainmenu.api import ApplicationMenus, ToolsMenuSections
from griffin.plugins.preferences import MOST_IMPORTANT_PAGES
from griffin.plugins.preferences.widgets.container import (
    PreferencesActions, PreferencesContainer)
from griffin.plugins.pythonpath.api import PythonpathActions
from griffin.plugins.toolbar.api import ApplicationToolbars, MainToolbarSections
...
class Preferences(GriffinPluginV2):
    """
    Griffin preferences plugin.
    ...
    def register_plugin_preferences(
        self,
        plugin: Union[GriffinPluginV2, GriffinPlugin]
    ) -> None:
        if (
    ...
    def deregister_plugin_preferences(
        ...
        if isinstance(plugin, GriffinPluginV2):
    ...
    def reset(self):
        answer = QMessageBox.warning(
            self.main,
            _("Warning"),
            _("Griffin will restart and reset to default settings:"
              "<br><br>"
    ...
    def get_description() -> str:
        return _("Manage Griffin's preferences.")
