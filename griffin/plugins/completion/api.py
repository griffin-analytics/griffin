...
"""
General Griffin completion API constants and enumerations.
...
TEXT_EDITOR_CAPABILITES = {
    ...
    "synchronization": {
        ...
        # The client (Griffin) will send a willSave notification
        # to the server when a file is about to be saved.
        "willSave": True,

        # The client (Griffin) supports sending a will save request and
        # waits for a response providing text edits which will
        # be applied to the document before it is saved.
        "willSaveWaitUntil": True,

        # The client (Griffin) supports did save notifications.
    ...
    "completion": {
        ...
        "completionItem": {
            # Client (Griffin) supports snippets as insert text.
    ...
    "hover": {
        ...
        # Hover contents can only be handled in plain text by Griffin
    ...
    "signatureHelp": {
        ...
        # Signature docs can only be handled in plain text by Griffin
...
# Griffin editor and workspace capabilities
...
COMPLETION_ENTRYPOINT = 'griffin.completions'

# -------------- GRIFFIN COMPLETION PROVIDER INTERFACE ---------------

class CompletionConfigurationObserver(GriffinConfigurationObserver):
    """
    Extension to the :class:`griffin.api.config.mixins.GriffinConfigurationObserver`
...
class GriffinCompletionProvider(QObject, CompletionConfigurationObserver):
    """
    Griffin provider API for completion providers.

    All completion providers must implement this interface in order to interact
    with Griffin CodeEditor and Projects manager.
    """
    ...
    completion_capabilites: dict
        ...
        to `griffin.plugins.completion.api.SERVER_CAPABILITES`.
    language: str
    ...
    """
    This signal is used to stop the completion services on Griffin plugins
    that depend on them.
    ...
    This signal is automatically connected to the main Griffin interface.
    """
    ...
    # Griffin Preferences dialog. This will allow users to graphically configure
    ...
    # :class:`griffin.api.widgets.status.StatusBarWidget` or
    ...
    def __init__(self, parent, config):
        ...
        Parameters
        ----------
        parent: griffin.plugins.completion.plugin.CompletionPlugin
        ...
        config: dict
            ...
            the current values according to the Griffin configuration system.
        """
    ...
    def send_request(
        ...
        """
        Send completion/introspection request from Griffin.
        ...
        req_type: str
            ...
            :class:`griffin.plugins.completion.api.CompletionRequestTypes`
        req: dict
            Request body
            {
                'filename': str,
    ...
    def send_notification(
        ...
        """
        Send notification to completion server based on Griffin changes.
    ...
    def broadcast_notification(
        ...
        notification_type: str
            Type of request, one of
            :class:`griffin.plugins.completion.CompletionTypes`
        notification: dict
            Notification body
            {
    ...
    def project_path_update(self, project_path: str, update_kind: str,
                            instance: Any):
        """
        Handle project path updates on Griffin.
        ...
        update_kind: str
            ...
            :class:`griffin.plugins.completion.api.WorkspaceUpdateKind`
        instance: object
            Reference to :class:`griffin.plugins.projects.plugin.Projects`
        """
        pass
    ...
    def python_path_update(self, new_path, prioritize):
        """
        Handle Python path updates on Griffin.
    ...
    def add_item_to_menu(self, action_or_menu, menu, section=None,
                         before=None):
        """
        Add a GriffinAction or a QWidget to the menu.
        """
    ...
    def add_item_to_application_menu(self, item, menu_id=None,
        ...
        menu: ApplicationMenu or None
            Instance of a Griffin application menu.
        menu_id: str or None
