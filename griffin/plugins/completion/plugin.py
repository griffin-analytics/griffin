...
# Local imports
from griffin.api.plugins import GriffinPluginV2, Plugins
...
from griffin.plugins.completion.api import (CompletionRequestTypes,
                                           GriffinCompletionProvider,
                                           COMPLETION_ENTRYPOINT)
from griffin.plugins.completion.confpage import CompletionConfigPage
from griffin.plugins.completion.container import CompletionContainer
...
class CompletionPlugin(GriffinPluginV2):
    """
    Griffin completion plugin.
    ...
    set of :class:`GriffinCompletionProvider` instances that are discovered
    ...
    """
    This signal is used to stop completion services on other Griffin plugins
    that depend on them.
    ...
    def register_statusbar_widgets(self, plugin_loaded=True):
        ...
        ----------
        plugin_loaded: bool
            True if the plugin is already loaded in Griffin, False if it is
    ...
    def gather_create_ops(self):
        ...
        :class:`griffin.api.preferences.PluginConfigPage` class
        """
    ...
    @staticmethod
    def _merge_default_configurations(Provider: GriffinCompletionProvider,
                                      provider_name: str,
    ...
    def get_provider_configuration(self, Provider: GriffinCompletionProvider,
    ...
    def update_request_priorities(self, Provider: GriffinCompletionProvider,
                                  provider_name: str):
    ...
    def connect_provider_signals(self, provider_instance):
        """Connect GriffinCompletionProvider signals."""
        container = self.get_container()
    ...
    def _instantiate_and_register_provider(
            self, Provider: GriffinCompletionProvider):
    ...
    def get_provider(self, name: str) -> GriffinCompletionProvider:
        """Get the :class:`GriffinCompletionProvider` identified with `name`."""
    ...
    def project_path_update(self, project_path: str, update_kind='addition',
        ...
        update_kind: str
            ...
            :class:`griffin.plugins.completion.WorkspaceUpdateKind`.
        instance: object
