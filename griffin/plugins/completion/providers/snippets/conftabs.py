...
from griffin.plugins.completion.providers.snippets.widgets import (
...
class SnippetsConfigTab(GriffinPreferencesTab):
    TITLE = _('Snippets')
    ...
    def __init__(self, parent):
        ...
        snippets_info_label = QLabel(
            _("Griffin allows to define custom completion snippets to use "
        ...
        self.snippets_language_cb = GriffinComboBox(self)
                ...
                if 'loading' in errors:
                    ...
                    QMessageBox.critical(
                        ...
                        _('The provided snippet file does not comply with '
                          'the Griffin JSON snippets spec and therefore it '
                    ...
                    QMessageBox.warning(
                        ...
                        _('Griffin was able to load {0}/{1} snippets '
