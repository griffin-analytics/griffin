...
from griffin.plugins.completion.api import (GriffinCompletionProvider,
                                           SUPPORTED_LANGUAGES)
from griffin.plugins.completion.providers.snippets.actor import SnippetsActor
from griffin.plugins.completion.providers.snippets.conftabs import (
    SnippetsConfigTab
)
...
class SnippetsProvider(GriffinCompletionProvider):
