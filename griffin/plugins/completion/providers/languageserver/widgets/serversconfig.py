...
from griffin.widgets.helperwidgets import ItemDelegate
...
class LSPServerEditor(QDialog, GriffinFontsMixin):
    ...
    def __init__(self, parent, language=None, cmd='', host='127.0.0.1',
        ...
        self.lang_cb = GriffinComboBox(self)
        ...
        self.bbox = GriffinDialogButtonBox(
        ...
        self.conf_input.setup_editor(
            ...
            font=self.get_font(GriffinFontType.MonospaceInterface)
        )
...
class LSPServersModel(QAbstractTableModel):
    def __init__(self, parent):
        ...
        self.text_color = GriffinPalette.COLOR_TEXT_1
