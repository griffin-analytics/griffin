...
"""
Griffin Language Server Protocol Client implementation.
...
from griffin.plugins.completion.providers.languageserver.transport import (
    MessageKind)
from griffin.plugins.completion.providers.languageserver.providers import (
    LSPMethodProviderMixIn)
from griffin.utils.misc import getcwd_or_home, select_port
...
@class_register
class LSPClient(QObject, LSPMethodProviderMixIn, GriffinConfigurationAccessor):
    ...
    #: Signal to report internal server errors through Griffin's
    #  facilities.
    ...
    def start_server(self):
        ...
        if self.language == 'python':
            ...
            if os.name == "nt":
                ...
                # that directory.
                # Fixes griffin-ide/griffin#17661
