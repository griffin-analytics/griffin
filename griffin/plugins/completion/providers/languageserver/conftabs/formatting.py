...
class FormattingStyleConfigTab(GriffinPreferencesTab):
    ...
    def __init__(self, parent):
        ...
        code_style_label = QLabel(
            _("Griffin can use pycodestyle to analyze your code for "
        ...
        code_fmt_label = QLabel(
            _("Griffin can use {0} or {1} to format your code for "
