...
"""
Griffin MS Language Server v3.0 transport proxy implementation.
...
# Local imports
from griffin.plugins.completion.providers.languageserver.transport.tcp.producer import (
    TCPLanguageServerClient)
from griffin.plugins.completion.providers.languageserver.transport.stdio.producer import (
...
parser = argparse.ArgumentParser(
    description='ZMQ Python-based MS Language-Server v3.0 client for Griffin')
