...
from griffin.api.widgets.status import BaseTimerStatus
...
from griffin.utils.stylesheet import WIN
from griffin.widgets.browser import WebView


class InAppAppealDialog(QDialog, GriffinFontsMixin):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(_("Help Griffin"))
        self.setWindowIcon(ima.icon("inapp_appeal"))

        # Path to the appeal page
        appeal_page_path = osp.join(
            get_module_source_path("griffin.plugins.application.widgets"),
            "appeal_page",
