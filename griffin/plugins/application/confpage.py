...
For historical reasons (dating back to Griffin 2) the main class here is called
...
from griffin.config.base import (_, DISABLED_LANGUAGES, LANGUAGE_CODES,
...
class ApplicationConfigPage(PluginConfigPage):
    ...
    def setup_page(self):
        ...
        popup_console_box = newcb(_("Show internal Griffin errors to report "
        ...
        if sys.platform == "darwin" and not is_conda_based_app():
            # To open files from Finder directly in Griffin.
            from griffin.utils.qthelpers import (register_app_launchservices,
            ...
            mac_open_file_box = newcb(
                _("Open files from Finder with Griffin"),
                'mac_open_file',
                tip=_("Register Griffin with the Launch Services"))
            ...
            if als.get_bundle_identifier() is None:
                ...
                macOS_layout.addWidget(QLabel(
                    _('Launch Griffin with <code>python.app</code> to enable'
    ...
    def perform_checks(self):
        ...
        # See griffin-ide/griffin#21733 for the details.
