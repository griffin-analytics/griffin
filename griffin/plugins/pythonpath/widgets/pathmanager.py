...
from griffin.plugins.pythonpath.utils import check_path, get_system_pythonpath
...
class PathManager(QDialog, GriffinWidgetMixin):
    """Path manager dialog."""
    ...
    def _stylesheet(self):
        ...
        # This is necessary to match the buttons style with the rest of Griffin
    ...
    def export_pythonpath(self):
        ...
        answer = QMessageBox.question(
            self,
            _("Export"),
            _("This will export Griffin's path list to the "
              "<b>PYTHONPATH</b> environment variable for the current user, "
              "allowing you to run your Python modules outside Griffin "
              "without having to configure sys.path. "
              "<br><br>"
              "Do you want to clear the contents of PYTHONPATH before "
              "adding Griffin's path list?"),
