...
from griffin.plugins.pythonpath.container import (
    PythonpathActions, PythonpathContainer)


class PythonpathManager(GriffinPluginV2):
    """
    Pythonpath manager plugin.
    """
    ...
    def on_main_menu_available(self):
        ...
        main_menu.add_item_to_application_menu(
            ...
            before=ApplicationActions.GriffinUserEnvVariables,
    ...
    def get_griffin_pythonpath(self):
        """Get Pythonpath paths handled by Griffin as a list."""
        return self.get_container().get_griffin_pythonpath()
