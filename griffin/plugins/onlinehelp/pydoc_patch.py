...
class CustomHTMLDoc(Doc, GriffinFontsMixin):
    ...
    def __init__(self):
        super().__init__()
        self.app_font = self.get_font(GriffinFontType.Interface)
        self.plain_font = self.get_font(GriffinFontType.Monospace)
