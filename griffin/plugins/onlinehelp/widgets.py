...
from griffin.plugins.onlinehelp.pydoc_patch import _start_server, _url_handler
...
class PydocBrowser(PluginMainWidget):
    ...
    def setup(self):
        from griffin.widgets.browser import WebViewActions
