...
from griffin.plugins.tours.api import GriffinWidgets as sw
from griffin import __docs_url__
...
TEST_TOUR = [
    {
        'title': "Welcome to Griffin introduction tour",
        'content': "<b>Griffin</b> is an interactive development "
...
INTRO_TOUR = [
    {
        ...
        'content': _("<b>Griffin</b> is a powerful Interactive "
    ...
    },
    {
        ...
        'content': _("This is where you write Python code before "
                     ...
                     "where Griffin shows warnings and syntax errors. "
    ...
    },
    {
        ...
        'content': _('You have reached the end of our tour and are '
                     'ready to start using Griffin! For more '
...
FEAT30 = [
    {
        'title': _("New features in Griffin 3.0"),
        'content': _("<b>Griffin</b> is an interactive development "
                     "environment based on bla"),
        'image': 'griffin_about',
    },
    {
        'title': _("Welcome to Griffin introduction tour"),
        'content': _("Griffin is an interactive development environment "
                     "based on bla"),
