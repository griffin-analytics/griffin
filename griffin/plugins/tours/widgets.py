...
from griffin.utils.stylesheet import AppStyle, DialogStyle


MAIN_TOP_COLOR = MAIN_BG_COLOR = QColor(GriffinPalette.COLOR_BACKGROUND_1)
...
class FadingCanvas(FadingDialog):
    ...
    def __init__(self, parent, opacity, duration, easing_curve, color,
        ...
        self.color = color
        # Decoration color
        self.color_decoration = QColor(GriffinPalette.COLOR_ERROR_2)
...
#        painter.fillPath(self.path_decoration, decoration_fill)
    ...
    def focusInEvent(self, event):
        """Override Qt method."""
        # To be used so tips do not appear outside griffin
        if self.hasFocus():
...
class FadingTipBox(FadingDialog):
    ...
    def __init__(self, parent, opacity, duration, easing_curve, tour=None,
        ...
        self.combo_title = GriffinComboBox()
...
class AnimatedTour(QWidget):
    ...
    def __init__(self, parent):
        ...
        # Widgets setup
        # Needed to fix griffin-ide/griffin#2204.
        self.setAttribute(Qt.WA_TransparentForMouseEvents)
        ...
        if (self.spy_window.isFullScreen() or
            ...
            if sys.platform == 'darwin':
                ...
                msg = _("To run the tour, please press the green button on "
                        "the left of the Griffin window's title bar to take "
...
class OpenTourDialog(QDialog, SvgToScaledPixmap):
    ...
    def __init__(self, parent, tour_function):
        ...
        self.setWindowTitle(_("Griffin tour"))
        ...
        image_label.setPixmap(
            self.svg_to_scaled_pixmap(
                "tour-griffin-logo", rescale=DialogStyle.IconScaleFactor
            )
        )
    ...
    def _buttons_stylesheet(self):
        ...
        css.QPushButton.setValues(
            color=GriffinPalette.COLOR_TEXT_1,
        ...
        css["QPushButton#launch-button"].setValues(
            backgroundColor=GriffinPalette.COLOR_ACCENT_2,
            borderColor=GriffinPalette.COLOR_ACCENT_2,
        )

        css["QPushButton#launch-button:hover:!pressed"].setValues(
            backgroundColor=GriffinPalette.COLOR_ACCENT_3,
        )

        css["QPushButton#launch-button:pressed"].setValues(
            backgroundColor=GriffinPalette.COLOR_ACCENT_4,
        )

        # Set style for dismiss button
        css["QPushButton#dismiss-button"].setValues(
            backgroundColor=GriffinPalette.COLOR_BACKGROUND_4,
            borderColor=GriffinPalette.COLOR_BACKGROUND_4,
        )
