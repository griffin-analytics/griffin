...
class EditorConfigPage(PluginConfigPage, GriffinConfigurationObserver):
    ...
    def setup_page(self):
        ...
        strip_mode_box = newcb(
            ...
            tip=_("If enabled, modified lines of code (excluding strings)\n"
                  ...
                  "If disabled, only whitespace added by Griffin will be stripped."))
        ...
        eol_label = QLabel(_("When opening a text file containing "
                             ...
                             "on Windows platforms), Griffin may fix the "
                             "file automatically."))
