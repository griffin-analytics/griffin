...
# Local imports
from griffin.plugins.completion.api import DiagnosticSeverity
from griffin.plugins.editor.api.panel import Panel
from griffin.plugins.editor.utils.editor import is_block_safe
...
class ScrollFlagArea(Panel):
    ...
    def paintEvent(self, event):
        ...
        # has zero height.
        # Fixes griffin-ide/griffin#21600
        try:
