...
"""
A Class and Function Dropdown Panel for Griffin.
"""
...
from griffin.api.widgets.comboboxes import GriffinComboBoxWithIcons
from griffin.plugins.completion.api import SymbolKind
...
class ClassFunctionDropdown(Panel):
    ...
    Parameters
    ----------
    editor : :class:`griffin.plugins.editor.widgets.codeeditor.CodeEditor`
    ...
    def __init__(self):
        ...
        # Widgets
        self.class_cb = GriffinComboBoxWithIcons(self)
        self.method_cb = GriffinComboBoxWithIcons(self)
    ...
    def populate(self, combobox, data, add_parents=False):
        ...
        Parameters
        ----------
        combobox : :class:`griffin.api.widgets.comboboxes.GriffinComboBox`
