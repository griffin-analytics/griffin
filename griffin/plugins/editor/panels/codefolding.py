...
from griffin.plugins.editor.panels.utils import FoldingRegion
from griffin.plugins.editor.utils.editor import (TextHelper, DelayJobRunner,
                                                drift_color)
from griffin.utils.icon_manager import ima
from griffin.widgets.mixins import EOL_SYMBOLS
...
class FoldingPanel(Panel):
    ...
    def paintEvent(self, event):
        ...
        if self._mouse_over_line is not None:
            ...
            try:
                ...
                # issue griffin-ide/griffin#10918.
            ...
            if line_number in self.folding_regions:
                ...
                if (self._mouse_over_line != block.blockNumber() and
                    ...
                    try:
                        ...
                        # Catching the KeyError above is necessary to avoid
                        # issue griffin-ide/griffin#13230.
                        pass
                else:
                    ...
                    try:
                        ...
                        # Catching the KeyError above is necessary to avoid
                        # issue griffin-ide/griffin#11291.
                        pass
    ...
    def _on_key_pressed(self, event):
        ...
        if self._in_folded_block():
            ...
            # See the last comments in griffin-ide/griffin#21669 for the details
            # of this decision.
            if (
    ...
    def _highlight_caret_scope(self):
        ...
        griffin.widgets.panels.FoldingPanel.highlight_care_scope` is True.
        """
        cursor = self.editor.textCursor()
