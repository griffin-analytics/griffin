...
from griffin.plugins.editor.widgets.editorstack.editorstack import EditorStack
...
class EditorSplitter(QSplitter, GriffinWidgetMixin):
    ...
    def __init__(self, parent, main_widget, menu_actions, first=False,
        ...
        if PYQT5 or PYQT6:
            ...
            GriffinWidgetMixin.__init__(self, class_parent=main_widget)
    ...
    def set_layout_settings(self, settings, dont_goto=None):
        ...
        for i, (is_vertical, cfname, clines) in enumerate(splitsettings):
            ...
            for j, finfo in enumerate(editorstack.data):
                ...
                # in a future PR (which will fix griffin-ide/griffin#3857).
    ...
    def _stylesheet(self):
        ...
        css.QSplitter.setValues(
            background=GriffinPalette.COLOR_BACKGROUND_1
        )
        return css.toString()
