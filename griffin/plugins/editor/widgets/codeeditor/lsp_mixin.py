...
from griffin.plugins.editor.panels.utils import (
    merge_folding,
...
class LSPMixin:
    ...
    def document_did_open(self):
        ...
        # Fixes griffin-ide/griffin#20679
        try:
    ...
    def _process_code_analysis(self, underline):
        ...
        for diagnostic in self._diagnostics:
            ...
            if underline:
                ...
                # Fixes griffin-ide/griffin#15618
    ...
    def process_completion(self, params):
        ...
        try:
            ...
            # Allow for textEdit completions to be filtered by Griffin
    ...
    def process_signatures(self, params):
        ...
        try:
            ...
            if signature_params is not None:
                ...
                # This method is part of griffin/widgets/mixins
                self.show_calltip(
                    signature=signature,
                    parameter=parameter,
                    language=self.language,
    ...
    def handle_hover_response(self, contents):
        ...
        try:
            ...
            if content is not None and self._show_hint and self._last_point:
                # This is located in griffin/widgets/mixins.py
    ...
    def _apply_document_edits(self, edits):
        ...
        # Fixes griffin-ide/griffin#16180
    ...
    def apply_code_folding(self, folding_info):
        ...
        # it.
        # Fixes griffin-ide/griffin#19514
    ...
    def notify_close(self):
        ...
        # Fixes griffin-ide/griffin#20071
        try:
