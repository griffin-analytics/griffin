...
def test_fallback_completions(completions_codeeditor, qtbot):
    ...
    # This is a regression test for issue griffin-ide/griffin#11862.
    qtbot.keyPress(code_editor, Qt.Key_Enter, delay=300)
    with qtbot.waitSignal(completion.sig_show_completions,
                          timeout=10000) as sig:
...
def test_completions(completions_codeeditor, qtbot):
    ...
    try:
        ...
        # This is a regression test for griffin-ide/griffin#11600
        pass
...
def spam():
    pass
'''
    CONF.set('pythonpath_manager', 'griffin_pythonpath', [])
    completion_plugin.after_configuration_update([])
    qtbot.wait(500)
    ...
    # Set extra paths
    print(extra_paths)
    CONF.set('pythonpath_manager', 'griffin_pythonpath', extra_paths)
    completion_plugin.after_configuration_update([])
    code_editor.document_did_change()
    qtbot.wait(500)
...
def test_dot_completions(completions_codeeditor, qtbot):
    ...
    This is a regression test for issue griffin-ide/griffin#20285
    """
    code_editor, _ = completions_codeeditor
    completion = code_editor.completion_widget
    code_editor.toggle_code_snippets(False)
...
def test_file_completions(filename, mock_completions_codeeditor, qtbot):
    ...
    This includes a regression test for issue griffin-ide/griffin#20156
    """
