...
# Local imports
from griffin.utils.vcs import get_git_remotes
...
@pytest.mark.parametrize('params', [
            ...
            ('# gh:griffin-ide/griffin#123\n', 'gh:griffin-ide/griffin#123', None,
             'https://github.com/griffin-ide/griffin/issues/123'),
            ('# gh:griffin-ide/griffin#123\n', 'gh:griffin-ide/griffin#123', None,
             'https://github.com/griffin-ide/griffin/issues/123'),
            pytest.param(('# gh-123\n', 'gh-123', HERE,
                          'https://github.com/griffin-ide/griffin/issues/123'),
...
def test_goto_uri(qtbot, codeeditor, mocker, params):
    ...
    with qtbot.waitSignal(code_editor.sig_uri_found, timeout=3000) as blocker:
        ...
        # Tests griffin-ide/griffin#9614.
...
def test_pattern_highlight_regression(qtbot, codeeditor):
    """Fix regression on griffin-ide/griffin#11376."""
    code_editor = codeeditor
    code_editor.show()
