...
from griffin.utils.qthelpers import keyevent_to_keysequence_str
...
class CompletionWidget(QListWidget, GriffinConfigurationAccessor):
    ...
    def set_item_display(self, item_widget, item_info, height, width):
        ...
        # See griffin-ide/griffin#17047 and
    ...
    def hide(self, focus_to_parent=True):
        ...
        # proposed for issue griffin-ide/griffin#11502.
        if focus_to_parent:
    ...
    def keyPressEvent(self, event):
        ...
        if key in (Qt.Key_Return, Qt.Key_Enter, Qt.Key_Tab):
            ...
            # Fixes griffin-ide/griffin#19989
            self.hide()
            self.textedit.keyPressEvent(event)
    ...
    def focusOutEvent(self, event):
        ...
        # Fixes griffin-ide/griffin#1318.
