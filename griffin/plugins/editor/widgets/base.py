...
from griffin.plugins.editor.api.decoration import TextDecoration, DRAW_ORDERS
from griffin.plugins.editor.utils.decoration import TextDecorationsManager
from griffin.plugins.editor.widgets.completion import CompletionWidget
from griffin.plugins.completion.api import CompletionItemKind
from griffin.plugins.outlineexplorer.api import is_cell_header, document_cells
from griffin.py3compat import to_text_string
from griffin.utils.palette import GriffinPalette
from griffin.widgets.calltip import CallTipWidget, ToolTipWidget
...
class TextEditBaseWidget(
    ...
    def __init__(self, parent=None, class_parent=None):
        ...
        GriffinWidgetMixin.__init__(self, class_parent=class_parent)
        ...
        self.currentline_color = QColor(
            GriffinPalette.COLOR_ERROR_2).lighter(190)
        self.currentcell_color = QColor(
            GriffinPalette.COLOR_ERROR_2).lighter(194)

        # Brace matching
        self.bracepos = None
        self.matched_p_color = QColor(GriffinPalette.COLOR_SUCCESS_1)
        self.unmatched_p_color = QColor(GriffinPalette.COLOR_ERROR_2)
    ...
    def set_palette(self, background, foreground):
        ...
        # Fixes griffin-ide/griffin#2028, griffin-ide/griffin#8069 and
        # griffin-ide/griffin#9248.
    ...
    def keyPressEvent(self, event):
        ...
        # copying text in HTML. See griffin-ide/griffin#2285.
    ...
    def paintEvent(self, e):
        ...
        See griffin-ide/griffin#11089 for more info.
        """
    ...
    def is_completion_widget_visible(self):
        ...
        try:
            ...
            # already been deleted. See griffin-ide/griffin#13248.
            return False
    ...
    def hide_completion_widget(self, focus_to_parent=True):
        ...
        # Fixes griffin-ide/griffin#19109
        try:
    ...
    def mousePressEvent(self, event):
        ...
        if sys.platform.startswith('linux') and event.button() == Qt.MidButton:
            ...
            # the paste method and avoid the strange griffin-ide/griffin#1445.
    ...
    def wheelEvent(self, event):
        ...
        # This feature is disabled on MacOS, see griffin-ide/griffin#1510.
