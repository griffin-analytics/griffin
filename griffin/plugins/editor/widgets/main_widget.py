...
from griffin.config.base import _, get_conf_path, running_under_pytest
from griffin.config.utils import (get_edit_filetypes, get_edit_filters,
                                 get_filter)
from griffin.plugins.editor.api.panel import Panel
from griffin.py3compat import qbytearray_to_str, to_text_string
from griffin.utils import encoding, programs, sourcecode
from griffin.utils.icon_manager import ima
from griffin.utils.qthelpers import create_action
from griffin.utils.misc import getcwd_or_home
from griffin.widgets.findreplace import FindReplace
from griffin.plugins.editor.api.run import (
    EditorRunConfiguration, FileRun, SelectionRun, CellRun,
    SelectionContextModificator, ExtraAction)
from griffin.plugins.editor.utils.autosave import AutosaveForPlugin
from griffin.plugins.editor.utils.switcher_manager import EditorSwitcherManager
...
from griffin.plugins.editor.widgets.splitter import EditorSplitter
from griffin.plugins.editor.widgets.window import EditorMainWindow
from griffin.plugins.editor.utils.bookmarks import (load_bookmarks,
                                                   update_bookmarks)
...
from griffin.widgets.mixins import BaseEditMixin
from griffin.widgets.printer import GriffinPrinter, GriffinPrintPreviewDialog
from griffin.widgets.simplecodeeditor import SimpleCodeEditor
...
class EditorMainWidget(PluginMainWidget):
    ...
    def setup(self):
        ...
        # Fixes griffin-ide/griffin#6055.
    ...
    def set_ancestor(self, ancestor):
        ...
        for editorstack in self.editorstacks:
            for finfo in editorstack.data:
                ...
                # in progress.
                # Fixes griffin-ide/griffin#17486
                try:
    ...
    def change_register_file_run_metadata(self, old_filename, new_filename):
        ...
        if (
            ...
            # Fixes griffin-ide/griffin#22630
    ...
    def register_completion_capabilities(self, capabilities, language):
        ...
        # services when Griffin starts with an open project.
    ...
    def update_edit_menu(self):
        ...
        # Linux distros.
        # Fixes griffin-ide/griffin#22432
            ...
            if self.untitled_num == 0:
                for finfo in current_es.data:
                    ...
                    if _("untitled") in current_filename:
                        ...
                        # griffin. Please see griffin-ide/griffin#7831
                        ...
                        try:
                            ...
                            # part.
                            # Please see griffin-ide/griffin#12892
                            self.untitled_num = 0
    ...
    def load(self, filenames=None, goto=None, word='',
        ...
        # Fixes griffin-ide/griffin#20055
        try:
            self.switch_to_plugin()
    ...
    def print_preview(self):
        ...
        # Create preview
        preview = GriffinPrintPreviewDialog(printer, self)
    ...
    def get_run_configuration_per_context(
        ...
        if context == RunContext.Selection:
            ...
            # was the behavior in Griffin 5 and users are accustomed to it.
            # Fixes griffin-ide/griffin#22060
