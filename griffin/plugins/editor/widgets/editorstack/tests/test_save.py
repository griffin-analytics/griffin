...
from griffin.plugins.debugger.panels.debuggerpanel import DebuggerPanel
from griffin.plugins.editor.widgets.editorstack import editorstack as editor
...
from griffin.plugins.editor.widgets.window import EditorMainWidgetExample
...
from griffin.plugins.debugger.utils.breakpointsmanager import BreakpointsManager
...
def test_save_as_with_outline(completions_editor, mocker, qtbot, tmpdir):
    ...
    Regression test for issues griffin-ide/griffin#7754 and
    griffin-ide/griffin#15517.
    """
...
def test_save_as_change_file_type(editor_bot, mocker, tmpdir):
    ...
    Regression test for griffin-ide/griffin#13085.
    """
...
def test_save_when_completions_are_visible(completions_editor, qtbot):
    ...
    Regression test for issue griffin-ide/griffin#14806.
    """
...
def test_save_as_lsp_calls(completions_editor, mocker, qtbot, tmpdir):
    ...
    Regression test for griffin-ide/griffin#13085 and griffin-ide/griffin#20047.
    """
    file_path, editorstack, code_editor, completion_plugin = completions_editor
