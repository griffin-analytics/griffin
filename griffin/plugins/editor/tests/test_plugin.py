...
from griffin.plugins.editor.widgets.editorstack import editorstack as editor_module
from griffin.plugins.editor.widgets.codeeditor import CodeEditor
from griffin.plugins.run.api import RunContext
from griffin.utils.sourcecode import get_eol_chars, get_eol_chars_from_os_name
...
def test_setup_open_files_cleanprefs(editor_plugin_open_files):
    ...
    Regression test for griffin-ide/griffin#8458.
    """
    editor_factory = editor_plugin_open_files
    editor, expected_filenames, expected_current_filename = (
        editor_factory(None, None))
...
def test_open_untitled_files(editor_plugin_open_files):
    ...
    Regression test for griffin-ide/griffin#7831
    """
    editor_factory = editor_plugin_open_files
    editor, expected_filenames, expected_current_filename = (
        editor_factory(None, None))
...
def test_renamed_tree(editor_plugin, mocker):
    ...
    if os.name == "nt":
        filenames = [r'C:\test\directory\file1.py',
                     ...
                     r'C:\home\griffin\testing\file3.py',
...
def test_renamed_propagates_to_autosave(editor_plugin_open_files, mocker):
    ...
    Regression test for griffin-ide/griffin#11348"""
    editor_factory = editor_plugin_open_files
    editor, expected_filenames, expected_current_filename = (
        editor_factory(None, None))
...
def test_go_to_prev_next_cursor_position(editor_plugin, python_files):
    ...
    Regression test for griffin-ide/griffin#8000.
    """
...
def test_remove_editorstacks_and_windows(editor_plugin, qtbot):
    ...
    This is a regression test for griffin-ide/griffin#20144.
    """
    # Create empty file
    editor_plugin.new()
...
def test_register_run_metadata(editor_plugin):
    ...
    This is a regression test for griffin-ide/griffin#22630.
    """
