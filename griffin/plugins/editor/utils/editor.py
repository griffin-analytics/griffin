...
"""
This module contains utility functions/classes for Griffin's Editor.
...
class DelayJobRunner(object):
    ...
    def _exec_requested_job(self):
        ...
        try:
            ...
            # issue griffin-ide/griffin#15712.
            pass
...
class TextHelper(object):
    ...
    def word_under_cursor(self, select_whole_word=False, text_cursor=None):
        ...
        :attr:`griffin.plugins.editor.widgets.codeeditor.CodeEditor.word_separators`.
