...
multiple instances of Griffin can run simultaneously.
...
see `griffin/plugins/editor/widgets/recover.py`.
"""
...
from griffin.plugins.editor.widgets.autosaveerror import AutosaveErrorDialog
from griffin.plugins.editor.widgets.recover import RecoveryDialog
from griffin.utils.programs import is_griffin_process
            ...
            if match:
                ...
                with open(full_name) as pidfile:
                    ...
                    try:
                        ...
                        # Pid file got corrupted, see griffin-ide/griffin#11375
...
class AutosaveForStack(object):
    ...
    In Griffin, the `name_mapping` and `file_hashes` are set to references to
    ...
    def save_autosave_mapping(self):
        ...
        The NNN in the file name is the pid of the Griffin process. If the
    ...
    def remove_autosave_file(self, filename):
        ...
        # but it's left unsaved in Griffin.
        # Fixes griffin-ide/griffin#19283
        try:
    ...
    def maybe_autosave(self, index):
        ...
        try:
            ...
            # This should not happen, but it does: griffin-ide/griffin#11468
    ...
    def file_renamed(self, old_name, new_name):
        ...
        try:
            ...
            # This should not happen, but it does: griffin-ide/griffin#12396
