...
# Local imports
from griffin.plugins.editor.api.editorextension import EditorExtension
from griffin.plugins.outlineexplorer.api import is_cell_header
...
class Panel(QWidget, EditorExtension):
    ...
    def on_install(self, editor):
        """
        Extends :meth:`griffin.api.EditorExtension.on_install` method to set the
