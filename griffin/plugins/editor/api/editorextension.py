...
class EditorExtension(object):
    ...
    PanelsManager:
        - :meth:
            `griffin.plugins.editor.widgets.codeeditor.CodeEditor.panels.append`

    Subclasses may/should override the following methods:

        - :meth:`griffin.api.EditorExtension.on_install`
        - :meth:`griffin.api.EditorExtension.on_uninstall`
        - :meth:`griffin.api.EditorExtension.on_state_changed`
    ...
    def editor(self):
        ...
        **READ ONLY**
        ...
        :rtype: griffin.plugins.editor.widgets.codeeditor.CodeEditor
        """
        return self._editor
    ...
    def enabled(self):
        ...
        :meth:`griffin.api.EditorExtension.on_state_changed` will be called as
    ...
    def __init__(self):
        ...
        :class:`griffin.widgets.sourcecode.CodeEditor` uses that as the
    ...
    def on_install(self, editor):
        ...
        :type editor: griffin.plugins.editor.widgets.codeeditor.CodeEditor
