...
class TextDecoration(QTextEdit.ExtraSelection):
    ...
    .. code-block:: python
        ...
        def a_slot(decoration):
            print(decoration)  # griffin: test-skip
    """
    ...
    def set_as_error(self, color=GriffinPalette.COLOR_ERROR_2):
        """
    ...
    def set_as_warning(self, color=QColor(GriffinPalette.COLOR_WARN_1)):
        """
