...
from griffin.api.plugins import GriffinDockablePlugin, Plugins
...
from griffin.plugins.editor.confpage import EditorConfigPage
from griffin.plugins.editor.widgets.main_widget import (
    EditorMainWidget,
    EditorWidgetActions
)
...
from griffin.plugins.run.api import RunContext


logger = logging.getLogger(__name__)


class Editor(GriffinDockablePlugin):
    """
    Editor plugin.
    """
    ...
    def on_ipyconsole_available(self):
        ...
        ipyconsole.register_griffin_kernel_call_handler(
    ...
    def on_ipyconsole_teardown(self):
        ...
        ipyconsole.unregister_griffin_kernel_call_handler('cell_count')
        ipyconsole.unregister_griffin_kernel_call_handler('current_filename')
        ipyconsole.unregister_griffin_kernel_call_handler('get_file_code')
        ipyconsole.unregister_griffin_kernel_call_handler('run_cell')
    ...
    def get_codeeditor_for_filename(self, filename):
        ...
        Returns
        -------
        griffin.plugins.editor.codeeditor.CodeEditor
    ...
    def load(self, *args, **kwargs):
        ...
        editorwindow: Optional[griffin.plugins.editor.widgets.window.EditorMainWindow]  # noqa
    ...
    def load_edit(self, filename):
        ...
        Used by `griffin.plugins.outlineexplorer.plugin.[on_editor_available|on_editor_teardown]`  # noqa
    ...
    def new(self, *args, **kwargs):
        ...
        editorstack: Optional[griffin.plugins.editor.widgets.editorstack.EditorStack]  # noqa
    ...
    def add_supported_run_configuration(self, *args, **kwargs):
        ...
        Parameters
        ----------
        config : griffin.plugins.editor.api.run.EditorRunConfiguration
    ...
    def get_current_editorstack(self):
        ...
        Returns
        -------
        griffin.plugins.editor.editorstack.EditorStack
