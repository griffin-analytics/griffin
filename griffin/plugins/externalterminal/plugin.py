...
from griffin.plugins.editor.api.run import FileRun, SelectionRun
from griffin.plugins.externalterminal.api import (
    ExtTerminalPyConfiguration, ExtTerminalShConfiguration)
from griffin.plugins.externalterminal.widgets.run_conf import (
...
class ExternalTerminal(GriffinPluginV2, RunExecutor):
    """External terminal plugin."""
