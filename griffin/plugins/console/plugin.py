...
from griffin.plugins.console.widgets.main_widget import (
    ConsoleWidget, ConsoleWidgetActions)
from griffin.plugins.mainmenu.api import ApplicationMenus, FileMenuSections
...
class Console(GriffinDockablePlugin):
    """
    Console widget
    """
    ...
    @staticmethod
    def get_description():
        return _('An internal Python console running Griffin itself.')
    ...
    def on_initialize(self):
        ...
        if previous_crash:
            error_data = dict(
                ...
                label=_("<h3>Griffin crashed during last session</h3>"),
