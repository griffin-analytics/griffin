...
from griffin.plugins.console.utils.ansihandler import ANSIEscapeCodeHandler
from griffin.utils.palette import GriffinPalette


MAIN_BG_COLOR = GriffinPalette.COLOR_BACKGROUND_1
MAIN_DEFAULT_FG_COLOR = GriffinPalette.COLOR_TEXT_1
MAIN_ERROR_FG_COLOR = GriffinPalette.COLOR_ERROR_1
MAIN_TB_FG_COLOR = GriffinPalette.COLOR_ACCENT_3
MAIN_PROMPT_FG_COLOR = GriffinPalette.COLOR_SUCCESS_1
