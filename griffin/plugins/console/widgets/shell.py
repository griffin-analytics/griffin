...
from griffin.config.base import _, get_conf_path, get_debug_level, STDERR
from griffin.config.manager import CONF
from griffin.py3compat import is_string, is_text_string, to_text_string
from griffin.utils import encoding
from griffin.utils.icon_manager import ima
from griffin.utils.qthelpers import (add_actions, create_action, keybinding,
                                    restore_keyevent)
from griffin.widgets.mixins import (GetHelpMixin, SaveHistoryMixin,
...
class ShellBaseWidget(
    ...
    def load_history(self):
        ...
        if osp.isfile(self.history_filename):
            ...
            # Fixes griffin-ide/griffin#19850
            try:
    ...
    def flush(self, error=False, prompt=False):
        ...
        # Fix for griffin-ide/griffin#2452
        try:
...
#
# from griffin.utils.debug import log_methods_calls
...
class TerminalWidget(ShellBaseWidget):
    ...
    INITHISTORY = ['%s *** Griffin Terminal History Log ***' % COM, COM,]
