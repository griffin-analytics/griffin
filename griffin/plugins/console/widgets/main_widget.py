...
from griffin.utils.installers import InstallerInternalError
from griffin.config.base import DEV, get_debug_level
from griffin.plugins.console.widgets.internalshell import InternalShell
from griffin.py3compat import to_text_string
from griffin.utils.environ import EnvDialog
from griffin.utils.misc import (get_error_match, getcwd_or_home,
                               remove_backslashes)
from griffin.utils.qthelpers import DialogManager, mimedata2url
from griffin.widgets.collectionseditor import CollectionsEditor
from griffin.widgets.findreplace import FindReplace
from griffin.widgets.reporterror import GriffinErrorDialog
...
class ConsoleWidget(PluginMainWidget):
    ...
    def __init__(self, name, plugin, parent=None):
        ...
        # Header message
        message = _(
            "Griffin Internal Console\n\n"
            "This console is used to report application\n"
            "internal errors and to inspect Griffin\n"
        ...
        self.error_dlg = None
        self.shell = InternalShell(  # TODO: Move to use GriffinWidgetMixin?
            parent=parent,
            commands=[],
            message=message,
    ...
    def report_issue(self):
        """Report an issue with the GriffinErrorDialog."""
        self._report_dlg = GriffinErrorDialog(self, is_report=True)
    ...
    def handle_exception(self, error_data, sender=None):
        ...
        Handle any exception that occurs during Griffin usage.
        ...
        sender: griffin.api.plugins.GriffinPluginV2, optional
