...
from griffin.plugins.completion.api import SymbolKind, SYMBOL_KIND_ICON
from griffin.utils.qthelpers import set_item_user_text
...
class OutlineExplorerTreeWidget(OneColumnTree):
    ...
    def file_renamed(self, editor, new_filename):
        ...
        if editor is None:
            ...
            # Fixes griffin-ide/griffin#8813.
            return
        ...
        if editor_id in list(self.editor_ids.values()):
            ...
            # Fixes griffin-ide/griffin#15517
            items.delete()
