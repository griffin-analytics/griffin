...
class FigureBrowser(QWidget, GriffinWidgetMixin):
    """
    ...
    point: QPoint
        The QPoint in global coordinates where the menu was requested.
    figure_thumbnail: griffin.plugins.plots.widget.figurebrowser.FigureThumbnail
    ...
    def __init__(self, parent=None, background_color=None):
        ...
        splitter.setStyleSheet(
            f"border-radius: {GriffinPalette.SIZE_BORDER_RADIUS}"
        )
    ...
    def show_fig_outline_in_viewer(self, state):
        ...
        if state is True:
            self.figviewer.figcanvas.setStyleSheet(
                ...
                GriffinPalette.COLOR_BACKGROUND_4
            )
        else:
            self.figviewer.figcanvas.setStyleSheet(
...
class FigureViewer(QScrollArea, GriffinWidgetMixin):
    """
...
class ThumbnailScrollBar(QFrame):
    ...
    def __init__(self, figure_viewer, parent=None, background_color=None):
        ...
        # See griffin-ide/griffin#10914 for more details.
    ...
    def setup_scrollarea(self):
        ...
        # are failing on macOS. See griffin-ide/griffin#11576.
    ...
    def dropEvent(self, event):
        ...
        # Fixes griffin-ide/griffin#22458
        self._thumbnails = []
        for i in range(n_thumbnails):
...
class FigureThumbnail(QWidget):
    ...
    def highlight_canvas(self, highlight):
        ...
        """
        if highlight:
            # See griffin-ide/griffin#21598 for choice of styling.
            self.canvas.setStyleSheet(
                "FigureCanvas{border: 3px solid %s;}" %
                GriffinPalette.COLOR_ACCENT_3
            )
        else:
