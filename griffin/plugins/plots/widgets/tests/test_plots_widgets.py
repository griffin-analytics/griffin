...
from griffin.plugins.plots.widgets.figurebrowser import (FigureBrowser,
                                                        FigureThumbnail)
from griffin.plugins.plots.widgets.figurebrowser import get_unique_figname
...
def test_save_all_figures(figbrowser, tmpdir, mocker, fmt):
    ...
    mocker.patch(
        'griffin.plugins.plots.widgets.figurebrowser.getexistingdirectory',
        return_value=None)
...
def test_scroll_down_to_newest_plot(figbrowser, tmpdir, qtbot):
    ...
    Test that covers griffin-ide/griffin#10914.
    """
    figbrowser.setFixedSize(500, 500)
