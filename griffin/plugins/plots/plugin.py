...
from griffin.plugins.plots.widgets.main_widget import PlotsWidget


class Plots(GriffinDockablePlugin, ShellConnectPluginMixin):
    """
    Plots plugin.
    """
    NAME = 'plots'
    ...
    def _on_first_plot(self):
        ...
        # the IPython console.
        # Fixes griffin-ide/griffin#15467
        ...
        # Fixes griffin-ide/griffin#15705
