...
from griffin.plugins.plots.plugin import Plots
from griffin.plugins.plots.widgets.main_widget import PlotsWidgetActions
from griffin.plugins.plots.widgets.tests.test_plots_widgets import (
