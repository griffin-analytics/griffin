...
# be rendered correctly. See griffin-ide/griffin#1138.
...
project = u"Griffin Help plugin"
copyright = u'The Griffin Project Contributors'
...
# Griffin: Disabled to fix conflict with qtwebview and mathjax.
# See griffin-ide/griffin#5514.
