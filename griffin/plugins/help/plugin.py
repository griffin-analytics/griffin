...
from griffin.plugins.help.confpage import HelpConfigPage
from griffin.plugins.help.widgets import HelpWidget


class HelpActions:
    # Documentation related
    ShowGriffinTutorialAction = "griffin_tutorial_action"


class Help(GriffinDockablePlugin):
    """
    ...
    def save_history(self):
        ...
        # See griffin-ide/griffin#8878 and griffin-ide/griffin#6864
        try:
