...
from griffin.config.base import DEV
...
class ToolbarContainer(PluginMainContainer):
    ...
    def create_application_toolbar(
        ...
        Returns
        -------
        griffin.api.widgets.toolbar.ApplicationToolbar
    ...
    def add_application_toolbar(self, toolbar, mainwindow=None):
        ...
        Parameters
        ----------
        toolbar: griffin.api.widgets.toolbars.ApplicationToolbar
    ...
    def get_application_toolbar(self, toolbar_id: str) -> ApplicationToolbar:
        ...
        Returns
        -------
        griffin.api.widgets.toolbars.ApplicationToolbar
    ...
    def load_application_toolbars(self):
        ...
        # Reorganize toolbars only if this is the first time Griffin starts or
