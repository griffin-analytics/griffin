...
from griffin.api.shellconnect.mixins import ShellConnectPluginMixin
from griffin.api.translations import _
from griffin.plugins.debugger.confpage import DebuggerConfigPage
from griffin.plugins.debugger.utils.breakpointsmanager import (
    BreakpointsManager, clear_all_breakpoints, clear_breakpoint)
from griffin.plugins.debugger.widgets.main_widget import (
...
from griffin.plugins.editor.utils.languages import ALL_LANGUAGES
from griffin.plugins.ipythonconsole.api import IPythonConsolePyConfiguration
from griffin.plugins.mainmenu.api import ApplicationMenus, DebugMenuSections
...
from griffin.plugins.editor.api.run import CellRun, SelectionRun


class Debugger(GriffinDockablePlugin, ShellConnectPluginMixin, RunExecutor):
    """Debugger plugin."""
