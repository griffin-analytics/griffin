...
from griffin.api.shellconnect.main_widget import ShellConnectMainWidget
from griffin.api.plugins import Plugins
from griffin.api.translations import _
from griffin.plugins.debugger.widgets.framesbrowser import (
    FramesBrowser, FramesBrowserState)
from griffin.plugins.debugger.widgets.breakpoint_table_view import (
...
from griffin.utils.stylesheet import APP_TOOLBAR_STYLESHEET
...
class DebuggerWidget(ShellConnectMainWidget):
    ...
    def create_new_widget(self, shellwidget):
        ...
        shellwidget.sig_config_griffin_kernel.connect(
    ...
    def close_widget(self, widget):
        ...
        shellwidget.sig_config_griffin_kernel.disconnect(
            widget.on_config_kernel)
    ...
    def _update_stylesheet(self, is_table_shown=False):
        ...
        if is_table_shown:
            ...
            border_radius = GriffinPalette.SIZE_BORDER_RADIUS
