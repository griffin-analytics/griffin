...
class FramesBrowser(QWidget, GriffinWidgetMixin):
...
class LineFrameItem(QTreeWidgetItem, GriffinFontsMixin):
    ...
    def __repr__(self):
        ...
        monospace_font = self.get_font(GriffinFontType.Monospace).family()
        formatted_text += (
