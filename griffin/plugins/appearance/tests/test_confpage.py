...
from griffin.plugins.appearance.plugin import Appearance
from griffin.widgets.config import GriffinConfigPage
from griffin.plugins.preferences.tests.conftest import (
...
def test_change_ui_theme_and_color_scheme(config_dialog, mocker, qtbot):
    ...
    mocker.patch.object(GriffinConfigPage, "prompt_restart_required")
    ...
    assert GriffinConfigPage.prompt_restart_required.call_count == 0
    ...
    assert GriffinConfigPage.prompt_restart_required.call_count == 1
