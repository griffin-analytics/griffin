...
# This is required to run our tests in VSCode or Griffin-unittest
...
from griffin.plugins.run.api import RunActions, StoredRunConfigurationExecutor
...
def start_new_kernel(startup_timeout=60, kernel_name='python', spykernel=False,
    ...
    if spykernel:
        km._kernel_spec = GriffinKernelSpec()
        ...
        if request.node.rep_call.failed:
            ...
            if close_main_window or known_leak:
                ...
                try:
                    ...
                    # Restore default Griffin Python Path
                    CONF.set(
                        'pythonpath_manager', 'griffin_pythonpath',
