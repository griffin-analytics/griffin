...
def get_options(argv=None):
    ...
    """
    parser = argparse.ArgumentParser(usage="griffin [options] files")
    parser.add_argument(
        '--new-instance',
        action='store_true',
        default=False,
        help="Run a new instance of Griffin, even if the single "
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help="Optimize Griffin bytecode (this may require "
    ...
    parser.add_argument(
        ...
        type=str,
        dest="project",
        help="Path that contains a Griffin project"
    )
    parser.add_argument(
        '--opengl',
        default=None,
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help="Show all Griffin configuration paths"
    )
    parser.add_argument(
        '--debug-info',
        default=None,
    ...
    parser.add_argument(
        ...
        help=("Print internal debugging info to the terminal and a file in "
              ...
              "called griffin-debug.log in the current working directory. "
              "Default is 'terminal'.")
    )
    parser.add_argument(
        '--filter-log',
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help="Disable the usage of web widgets in Griffin (e.g. the Help and "
             "Online help panes)."
    )
    parser.add_argument(
        '--report-segfault',
    ...
    parser.add_argument(
        ...
        dest="conf_dir",
        default=None,
        help="Choose a configuration directory to use for Griffin."
    )
    parser.add_argument(
        '--connect-to-kernel',
        type=str,
