...
from griffin.config.base import STDERR
...
def find_internal_plugins():
    ...
    for entry_point in entry_points(group="griffin.plugins"):
    ...
    for entry_point in entry_points(group="griffin.plugins"):
        ...
        if name not in internal_names:
            try:
                ...
                plugin_class._griffin_module_name = entry_point.module
                plugin_class._griffin_package_name = entry_point.dist.name
                plugin_class._griffin_version = entry_point.dist.version
                ...
                # We catch any error here to avoid Griffin to crash at startup
