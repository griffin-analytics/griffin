...
from griffin_kernels.customize.utils import path_is_library
...
class UserModuleReloader:
    ...
    def __init__(self, namelist=None, pathlist=None, shell=None):
        ...
        # Griffin modules
        spy_modules = ['griffin_kernels']

        # Matplotlib modules
        mpl_modules = ['matplotlib', 'tkinter', 'Tkinter']

        # Add other, necessary modules to the UMR blacklist
        # astropy: See griffin-ide/griffin#6962
        # pytorch: See griffin-ide/griffin#7041
        # fastmat: See griffin-ide/griffin#7190
        # pythoncom: See griffin-ide/griffin#7190
        # tensorflow: See griffin-ide/griffin#8697
    ...
    def run(self):
        ...
        if self.verbose and modnames_to_reload:
            ...
            color = colors["dark"]
            if self._shell:
                color = colors[self._shell.get_griffin_theme()]
