...
# site files
#
# Griffin consoles sitecustomize
#
...
# See griffin-ide/griffin/issues/2970
try:
    from PyQt5 import QtWidgets

    class GriffinQApplication(QtWidgets.QApplication):
        def __init__(self, *args, **kwargs):
            super(GriffinQApplication, self).__init__(*args, **kwargs)
            # Add reference to avoid destruction
            # This creates a Memory leak but avoids a Segmentation fault
            GriffinQApplication._instance_list.append(self)

    GriffinQApplication._instance_list = []
    QtWidgets.QApplication = GriffinQApplication
except Exception:
    pass
...
try:
    ...
    class GriffinQApplication(QtGui.QApplication):
        def __init__(self, *args, **kwargs):
            super(GriffinQApplication, self).__init__(*args, **kwargs)
            # Add reference to avoid destruction
            # This creates a Memory leak but avoids a Segmentation fault
    ...
    GriffinQApplication._instance_list = []
    QtGui.QApplication = GriffinQApplication
except Exception:
    pass
...
# =============================================================================
# Remove TMPDIR env var in case it was set by Griffin
# =============================================================================
# See griffin-ide/griffin#22382 and griffin-ide/griffin#22394 for the details.
def restore_tmpdir():
