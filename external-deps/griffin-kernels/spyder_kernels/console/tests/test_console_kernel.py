...
# Local imports
from griffin_kernels.comms.commbase import CommBase
from griffin_kernels.customize.griffinpdb import GriffinPdb
from griffin_kernels.utils.iofuncs import iofunctions
from griffin_kernels.utils.pythonenv import PythonEnvType
from griffin_kernels.utils.test_utils import get_kernel, get_log_text
...
def test_cwd_in_sys_path():
    ...
    cmd = "from griffin_kernels.console import start; start.main()"
...
def test_comprehensions_with_locals_in_pdb(kernel):
    ...
    This is a regression test for griffin-ide/griffin#13909.
    """
    pdb_obj = GriffinPdb()
    pdb_obj.curframe = inspect.currentframe()
...
def test_comprehensions_with_locals_in_pdb_2(kernel):
    ...
    This is a regression test for griffin-ide/griffin#16790.
    """
    pdb_obj = GriffinPdb()
    pdb_obj.curframe = inspect.currentframe()
    pdb_obj.curframe_locals = pdb_obj.curframe.f_locals
...
def test_functions_with_locals_in_pdb(kernel):
    ...
    This is a regression test for griffin-ide/griffin-kernels#345
    """
    pdb_obj = GriffinPdb()
...
def test_functions_with_locals_in_pdb_2(kernel):
    ...
    This is another regression test for griffin-ide/griffin-kernels#345
    """
    baba = 1  # noqa
    pdb_obj = GriffinPdb()
    pdb_obj.curframe = inspect.currentframe()
...
def test_non_strings_in_locals(kernel):
    ...
    This is a regression test for issue griffin-ide/griffin#19145
    """
...
def test_django_settings(kernel):
    ...
    This is a regression test for issue griffin-ide/griffin#19516
    """
...
def test_get_pythonenv_info(kernel):
    ...
    # Check these keys are present. Otherwise we'll break Griffin.
