...
def get_numpy_dtype(obj):
    ...
    if np.ndarray is not FakeObject:
        ...
        # below.
        # Note: The try/except is necessary to fix griffin-ide/griffin#19516.
        try:
            scalar_or_array = (
...
def get_size(item):
    ...
    try:
        if (
            ...
            # Fixes griffin-ide/griffin#16844
            return 1
        elif (
            ...
            try:
                ...
                # Fixes griffin-ide/griffin-kernels#217
                return (-1, -1)
...
def datestr_to_datetime(value):
    ...
    print(value, "-->", v)  # griffin: test-skip
    return v
...
def value_to_display(value, minmax=False, level=0):
    ...
    # Truncate display at 70 chars to avoid freezing Griffin
